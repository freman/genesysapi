...
func (o *GetAuditsQueryTransactionIDParams) WithTimeout(timeout time.Duration) *GetAuditsQueryTransactionIDParams {
...
func (o *GetAuditsQueryTransactionIDParams) WithContext(ctx context.Context) *GetAuditsQueryTransactionIDParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get audits query transaction Id params
func (o *GetAuditsQueryTransactionIDParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get audits query transaction Id params
func (o *GetAuditsQueryTransactionIDParams) WithHTTPClient(client *http.Client) *GetAuditsQueryTransactionIDParams {
...
func (o *GetAuditsQueryTransactionIDParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
