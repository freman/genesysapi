...
func (o *GetJourneyActionmapsParams) SetDefaults() {
	...
	val := GetJourneyActionmapsParams{
...
func (o *GetJourneyActionmapsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.ActionMapIds != nil {

		// binding items for actionMapIds
		joinedActionMapIds := o.bindParamActionMapIds(reg)
...
// bindParamGetJourneyActionmaps binds the parameter actionMapIds
func (o *GetJourneyActionmapsParams) bindParamActionMapIds(formats strfmt.Registry) []string {
	actionMapIdsIR := o.ActionMapIds

	var actionMapIdsIC []string
	for _, actionMapIdsIIR := range actionMapIdsIR { // explode []string

		actionMapIdsIIV := actionMapIdsIIR // string as string
		actionMapIdsIC = append(actionMapIdsIC, actionMapIdsIIV)
	}

	// items.CollectionFormat: "multi"
	actionMapIdsIS := swag.JoinByFormat(actionMapIdsIC, "multi")

	return actionMapIdsIS
}

// bindParamGetJourneyActionmaps binds the parameter queryFields
func (o *GetJourneyActionmapsParams) bindParamQueryFields(formats strfmt.Registry) []string {
