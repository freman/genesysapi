...
func (o *GetRecordingMediaretentionpoliciesParams) WithDefaults() *GetRecordingMediaretentionpoliciesParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetRecordingMediaretentionpoliciesParams) SetDefaults() {
	var (
	...
	val := GetRecordingMediaretentionpoliciesParams{
...
// bindParamGetRecordingMediaretentionpolicies binds the parameter expand
func (o *GetRecordingMediaretentionpoliciesParams) bindParamExpand(formats strfmt.Registry) []string {
	expandIR := o.Expand
