...
func (o *GetOrphanrecordingsParams) WithDefaults() *GetOrphanrecordingsParams {
	o.SetDefaults()
	return o
}
...
// bindParamGetOrphanrecordings binds the parameter expand
func (o *GetOrphanrecordingsParams) bindParamExpand(formats strfmt.Registry) []string {
	expandIR := o.Expand
