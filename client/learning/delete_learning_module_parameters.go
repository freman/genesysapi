...
DeleteLearningModuleParams contains all the parameters to send to the API endpoint
	...
	for the delete learning module operation.
...
// WithDefaults hydrates default values in the delete learning module params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteLearningModuleParams) WithDefaults() *DeleteLearningModuleParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete learning module params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteLearningModuleParams) SetDefaults() {
