...
GetConfigurationSchemasEdgesVnextParams contains all the parameters to send to the API endpoint
	...
	for the get configuration schemas edges vnext operation.
...
// WithDefaults hydrates default values in the get configuration schemas edges vnext params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetConfigurationSchemasEdgesVnextParams) WithDefaults() *GetConfigurationSchemasEdgesVnextParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get configuration schemas edges vnext params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetConfigurationSchemasEdgesVnextParams) SetDefaults() {
	var (
	...
	val := GetConfigurationSchemasEdgesVnextParams{
