...
PostTelephonyProvidersEdgesTrunkbasesettingsParams contains all the parameters to send to the API endpoint
	...
	for the post telephony providers edges trunkbasesettings operation.
...
// WithDefaults hydrates default values in the post telephony providers edges trunkbasesettings params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostTelephonyProvidersEdgesTrunkbasesettingsParams) WithDefaults() *PostTelephonyProvidersEdgesTrunkbasesettingsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the post telephony providers edges trunkbasesettings params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostTelephonyProvidersEdgesTrunkbasesettingsParams) SetDefaults() {
