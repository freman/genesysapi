...
func (o *GetTelephonySiptracesDownloadDownloadIDParams) WithDefaults() *GetTelephonySiptracesDownloadDownloadIDParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetTelephonySiptracesDownloadDownloadIDParams) SetDefaults() {
