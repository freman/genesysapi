...
/*GetLanguagesForbidden handles this case with default header values.
...
/*GetLanguagesNotFound handles this case with default header values.
...
/*GetLanguagesRequestTimeout handles this case with default header values.
...
/*GetLanguagesRequestEntityTooLarge handles this case with default header values.
...
/*GetLanguagesUnsupportedMediaType handles this case with default header values.
...
/*GetLanguagesTooManyRequests handles this case with default header values.
...
/*GetLanguagesInternalServerError handles this case with default header values.
...
/*GetLanguagesServiceUnavailable handles this case with default header values.
...
/*GetLanguagesGatewayTimeout handles this case with default header values.
