...
GetOutboundEventParams contains all the parameters to send to the API endpoint
	...
	for the get outbound event operation.
...
// WithDefaults hydrates default values in the get outbound event params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetOutboundEventParams) WithDefaults() *GetOutboundEventParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get outbound event params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetOutboundEventParams) SetDefaults() {
