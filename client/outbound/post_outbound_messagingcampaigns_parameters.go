...
PostOutboundMessagingcampaignsParams contains all the parameters to send to the API endpoint
	...
	for the post outbound messagingcampaigns operation.
...
// WithDefaults hydrates default values in the post outbound messagingcampaigns params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostOutboundMessagingcampaignsParams) WithDefaults() *PostOutboundMessagingcampaignsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the post outbound messagingcampaigns params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostOutboundMessagingcampaignsParams) SetDefaults() {
