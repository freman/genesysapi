...
GetOutboundCallanalysisresponsesetsParams contains all the parameters to send to the API endpoint
	...
	for the get outbound callanalysisresponsesets operation.
...
// WithDefaults hydrates default values in the get outbound callanalysisresponsesets params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetOutboundCallanalysisresponsesetsParams) WithDefaults() *GetOutboundCallanalysisresponsesetsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get outbound callanalysisresponsesets params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetOutboundCallanalysisresponsesetsParams) SetDefaults() {
	var (
	...
	val := GetOutboundCallanalysisresponsesetsParams{
...
// WithAllowEmptyResult adds the allowEmptyResult to the get outbound callanalysisresponsesets params
func (o *GetOutboundCallanalysisresponsesetsParams) WithAllowEmptyResult(allowEmptyResult *bool) *GetOutboundCallanalysisresponsesetsParams {
	o.SetAllowEmptyResult(allowEmptyResult)
	return o
}

// SetAllowEmptyResult adds the allowEmptyResult to the get outbound callanalysisresponsesets params
func (o *GetOutboundCallanalysisresponsesetsParams) SetAllowEmptyResult(allowEmptyResult *bool) {
