...
func (o *PostUploadsWorkforcemanagementHistoricaldataJSONReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 408:
		result := NewPostUploadsWorkforcemanagementHistoricaldataJSONRequestTimeout()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewPostUploadsWorkforcemanagementHistoricaldataJSONRequestTimeout creates a PostUploadsWorkforcemanagementHistoricaldataJSONRequestTimeout with default headers values
func NewPostUploadsWorkforcemanagementHistoricaldataJSONRequestTimeout() *PostUploadsWorkforcemanagementHistoricaldataJSONRequestTimeout {
	return &PostUploadsWorkforcemanagementHistoricaldataJSONRequestTimeout{}
}

/*PostUploadsWorkforcemanagementHistoricaldataJSONRequestTimeout handles this case with default header values.

The client did not produce a request within the server timeout limit. This can be caused by a slow network connection and/or large payloads.
*/
type PostUploadsWorkforcemanagementHistoricaldataJSONRequestTimeout struct {
	Payload *models.ErrorBody
}

func (o *PostUploadsWorkforcemanagementHistoricaldataJSONRequestTimeout) Error() string {
	return fmt.Sprintf("[POST /api/v2/uploads/workforcemanagement/historicaldata/json][%d] postUploadsWorkforcemanagementHistoricaldataJsonRequestTimeout  %+v", 408, o.Payload)
}

func (o *PostUploadsWorkforcemanagementHistoricaldataJSONRequestTimeout) GetPayload() *models.ErrorBody {
	return o.Payload
}

func (o *PostUploadsWorkforcemanagementHistoricaldataJSONRequestTimeout) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
