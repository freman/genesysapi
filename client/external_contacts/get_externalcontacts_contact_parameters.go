...
GetExternalcontactsContactParams contains all the parameters to send to the API endpoint
	...
	for the get externalcontacts contact operation.
...
// WithDefaults hydrates default values in the get externalcontacts contact params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetExternalcontactsContactParams) WithDefaults() *GetExternalcontactsContactParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get externalcontacts contact params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetExternalcontactsContactParams) SetDefaults() {
...
// bindParamGetExternalcontactsContact binds the parameter expand
func (o *GetExternalcontactsContactParams) bindParamExpand(formats strfmt.Registry) []string {
	expandIR := o.Expand
