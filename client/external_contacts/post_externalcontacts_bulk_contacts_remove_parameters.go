...
PostExternalcontactsBulkContactsRemoveParams contains all the parameters to send to the API endpoint
	...
	for the post externalcontacts bulk contacts remove operation.
...
// WithDefaults hydrates default values in the post externalcontacts bulk contacts remove params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostExternalcontactsBulkContactsRemoveParams) WithDefaults() *PostExternalcontactsBulkContactsRemoveParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the post externalcontacts bulk contacts remove params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostExternalcontactsBulkContactsRemoveParams) SetDefaults() {
