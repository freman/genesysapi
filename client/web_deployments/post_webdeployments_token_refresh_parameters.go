...
// NewPostWebdeploymentsTokenRefreshParams creates a new PostWebdeploymentsTokenRefreshParams object,
...
func NewPostWebdeploymentsTokenRefreshParams() *PostWebdeploymentsTokenRefreshParams {
	return &PostWebdeploymentsTokenRefreshParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPostWebdeploymentsTokenRefreshParamsWithTimeout creates a new PostWebdeploymentsTokenRefreshParams object
...
// NewPostWebdeploymentsTokenRefreshParamsWithContext creates a new PostWebdeploymentsTokenRefreshParams object
...
// NewPostWebdeploymentsTokenRefreshParamsWithHTTPClient creates a new PostWebdeploymentsTokenRefreshParams object
...
func (o *PostWebdeploymentsTokenRefreshParams) WithDefaults() *PostWebdeploymentsTokenRefreshParams {
	o.SetDefaults()
	return o
}
...
func (o *PostWebdeploymentsTokenRefreshParams) WithTimeout(timeout time.Duration) *PostWebdeploymentsTokenRefreshParams {
...
func (o *PostWebdeploymentsTokenRefreshParams) WithContext(ctx context.Context) *PostWebdeploymentsTokenRefreshParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the post webdeployments token refresh params
func (o *PostWebdeploymentsTokenRefreshParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the post webdeployments token refresh params
func (o *PostWebdeploymentsTokenRefreshParams) WithHTTPClient(client *http.Client) *PostWebdeploymentsTokenRefreshParams {
...
func (o *PostWebdeploymentsTokenRefreshParams) WithBody(body *models.WebDeploymentsRefreshJWTRequest) *PostWebdeploymentsTokenRefreshParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post webdeployments token refresh params
func (o *PostWebdeploymentsTokenRefreshParams) SetBody(body *models.WebDeploymentsRefreshJWTRequest) {
	o.Body = body
}

// WriteToRequest writes these params to a swagger request
func (o *PostWebdeploymentsTokenRefreshParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
