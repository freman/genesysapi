...
func (o *GetUserPresencesMicrosoftteamsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 408:
		result := NewGetUserPresencesMicrosoftteamsRequestTimeout()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetUserPresencesMicrosoftteamsRequestTimeout creates a GetUserPresencesMicrosoftteamsRequestTimeout with default headers values
func NewGetUserPresencesMicrosoftteamsRequestTimeout() *GetUserPresencesMicrosoftteamsRequestTimeout {
	return &GetUserPresencesMicrosoftteamsRequestTimeout{}
}

/*GetUserPresencesMicrosoftteamsRequestTimeout handles this case with default header values.

The client did not produce a request within the server timeout limit. This can be caused by a slow network connection and/or large payloads.
*/
type GetUserPresencesMicrosoftteamsRequestTimeout struct {
	Payload *models.ErrorBody
}

func (o *GetUserPresencesMicrosoftteamsRequestTimeout) Error() string {
	return fmt.Sprintf("[GET /api/v2/users/{userId}/presences/microsoftteams][%d] getUserPresencesMicrosoftteamsRequestTimeout  %+v", 408, o.Payload)
}

func (o *GetUserPresencesMicrosoftteamsRequestTimeout) GetPayload() *models.ErrorBody {
	return o.Payload
}

func (o *GetUserPresencesMicrosoftteamsRequestTimeout) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
