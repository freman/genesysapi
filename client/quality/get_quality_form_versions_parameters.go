...
// NewGetQualityFormVersionsParams creates a new GetQualityFormVersionsParams object,
...
func NewGetQualityFormVersionsParams() *GetQualityFormVersionsParams {
	return &GetQualityFormVersionsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetQualityFormVersionsParamsWithTimeout creates a new GetQualityFormVersionsParams object
...
// NewGetQualityFormVersionsParamsWithContext creates a new GetQualityFormVersionsParams object
...
// NewGetQualityFormVersionsParamsWithHTTPClient creates a new GetQualityFormVersionsParams object
...
func (o *GetQualityFormVersionsParams) WithDefaults() *GetQualityFormVersionsParams {
	o.SetDefaults()
	return o
}
...
func (o *GetQualityFormVersionsParams) SetDefaults() {
	...
	val := GetQualityFormVersionsParams{
...
func (o *GetQualityFormVersionsParams) WithTimeout(timeout time.Duration) *GetQualityFormVersionsParams {
...
func (o *GetQualityFormVersionsParams) WithContext(ctx context.Context) *GetQualityFormVersionsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetQualityFormVersionsParams) WithHTTPClient(client *http.Client) *GetQualityFormVersionsParams {
...
func (o *GetQualityFormVersionsParams) WithFormID(formID string) *GetQualityFormVersionsParams {
	o.SetFormID(formID)
	return o
}
...
func (o *GetQualityFormVersionsParams) WithPageSize(pageSize *int32) *GetQualityFormVersionsParams {
...
func (o *GetQualityFormVersionsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
