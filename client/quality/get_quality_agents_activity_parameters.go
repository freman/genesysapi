...
func (o *GetQualityAgentsActivityParams) WithDefaults() *GetQualityAgentsActivityParams {
	o.SetDefaults()
	return o
}
...
func (o *GetQualityAgentsActivityParams) SetDefaults() {
	...
	val := GetQualityAgentsActivityParams{
...
func (o *GetQualityAgentsActivityParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.AgentUserID != nil {
		...
		// binding items for agentUserId
		joinedAgentUserID := o.bindParamAgentUserID(reg)
...
// bindParamGetQualityAgentsActivity binds the parameter agentUserId
func (o *GetQualityAgentsActivityParams) bindParamAgentUserID(formats strfmt.Registry) []string {
	agentUserIDIR := o.AgentUserID

	var agentUserIDIC []string
	for _, agentUserIDIIR := range agentUserIDIR { // explode []string

		agentUserIDIIV := agentUserIDIIR // string as string
		agentUserIDIC = append(agentUserIDIC, agentUserIDIIV)
	}

	// items.CollectionFormat: "multi"
	agentUserIDIS := swag.JoinByFormat(agentUserIDIC, "multi")

	return agentUserIDIS
}

// bindParamGetQualityAgentsActivity binds the parameter expand
func (o *GetQualityAgentsActivityParams) bindParamExpand(formats strfmt.Registry) []string {
	expandIR := o.Expand
