...
func (o *GetQualityEvaluationsQueryParams) WithDefaults() *GetQualityEvaluationsQueryParams {
	o.SetDefaults()
	return o
}
...
func (o *GetQualityEvaluationsQueryParams) SetDefaults() {
	...
	val := GetQualityEvaluationsQueryParams{
...
func (o *GetQualityEvaluationsQueryParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.EvaluationState != nil {

		// binding items for evaluationState
		joinedEvaluationState := o.bindParamEvaluationState(reg)
...
// bindParamGetQualityEvaluationsQuery binds the parameter evaluationState
func (o *GetQualityEvaluationsQueryParams) bindParamEvaluationState(formats strfmt.Registry) []string {
	evaluationStateIR := o.EvaluationState

	var evaluationStateIC []string
	for _, evaluationStateIIR := range evaluationStateIR { // explode []string

		evaluationStateIIV := evaluationStateIIR // string as string
		evaluationStateIC = append(evaluationStateIC, evaluationStateIIV)
	}

	// items.CollectionFormat: "multi"
	evaluationStateIS := swag.JoinByFormat(evaluationStateIC, "multi")

	return evaluationStateIS
}

// bindParamGetQualityEvaluationsQuery binds the parameter expand
func (o *GetQualityEvaluationsQueryParams) bindParamExpand(formats strfmt.Registry) []string {
	expandIR := o.Expand
