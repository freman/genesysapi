...
// NewGetQualityFormsSurveyVersionsParams creates a new GetQualityFormsSurveyVersionsParams object,
...
func NewGetQualityFormsSurveyVersionsParams() *GetQualityFormsSurveyVersionsParams {
	return &GetQualityFormsSurveyVersionsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetQualityFormsSurveyVersionsParamsWithTimeout creates a new GetQualityFormsSurveyVersionsParams object
...
// NewGetQualityFormsSurveyVersionsParamsWithContext creates a new GetQualityFormsSurveyVersionsParams object
...
// NewGetQualityFormsSurveyVersionsParamsWithHTTPClient creates a new GetQualityFormsSurveyVersionsParams object
...
func (o *GetQualityFormsSurveyVersionsParams) WithDefaults() *GetQualityFormsSurveyVersionsParams {
	o.SetDefaults()
	return o
}
...
func (o *GetQualityFormsSurveyVersionsParams) SetDefaults() {
	...
	val := GetQualityFormsSurveyVersionsParams{
...
func (o *GetQualityFormsSurveyVersionsParams) WithTimeout(timeout time.Duration) *GetQualityFormsSurveyVersionsParams {
...
func (o *GetQualityFormsSurveyVersionsParams) WithContext(ctx context.Context) *GetQualityFormsSurveyVersionsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get quality forms survey versions params
func (o *GetQualityFormsSurveyVersionsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get quality forms survey versions params
func (o *GetQualityFormsSurveyVersionsParams) WithHTTPClient(client *http.Client) *GetQualityFormsSurveyVersionsParams {
...
func (o *GetQualityFormsSurveyVersionsParams) WithFormID(formID string) *GetQualityFormsSurveyVersionsParams {
	o.SetFormID(formID)
	return o
}
...
func (o *GetQualityFormsSurveyVersionsParams) WithPageNumber(pageNumber *int32) *GetQualityFormsSurveyVersionsParams {
...
func (o *GetQualityFormsSurveyVersionsParams) WithPageSize(pageSize *int32) *GetQualityFormsSurveyVersionsParams {
...
func (o *GetQualityFormsSurveyVersionsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
