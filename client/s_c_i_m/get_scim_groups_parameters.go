...
// bindParamGetScimGroups binds the parameter attributes
func (o *GetScimGroupsParams) bindParamAttributes(formats strfmt.Registry) []string {
...
// bindParamGetScimGroups binds the parameter excludedAttributes
func (o *GetScimGroupsParams) bindParamExcludedAttributes(formats strfmt.Registry) []string {
