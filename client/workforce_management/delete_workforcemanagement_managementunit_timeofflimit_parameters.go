...
DeleteWorkforcemanagementManagementunitTimeofflimitParams contains all the parameters to send to the API endpoint
	...
	for the delete workforcemanagement managementunit timeofflimit operation.
...
// WithDefaults hydrates default values in the delete workforcemanagement managementunit timeofflimit params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteWorkforcemanagementManagementunitTimeofflimitParams) WithDefaults() *DeleteWorkforcemanagementManagementunitTimeofflimitParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete workforcemanagement managementunit timeofflimit params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteWorkforcemanagementManagementunitTimeofflimitParams) SetDefaults() {
