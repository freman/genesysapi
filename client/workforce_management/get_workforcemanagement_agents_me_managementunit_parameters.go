...
GetWorkforcemanagementAgentsMeManagementunitParams contains all the parameters to send to the API endpoint
	...
	for the get workforcemanagement agents me managementunit operation.
...
// WithDefaults hydrates default values in the get workforcemanagement agents me managementunit params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetWorkforcemanagementAgentsMeManagementunitParams) WithDefaults() *GetWorkforcemanagementAgentsMeManagementunitParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get workforcemanagement agents me managementunit params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetWorkforcemanagementAgentsMeManagementunitParams) SetDefaults() {
