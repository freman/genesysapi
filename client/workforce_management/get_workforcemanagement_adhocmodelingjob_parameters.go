...
GetWorkforcemanagementAdhocmodelingjobParams contains all the parameters to send to the API endpoint
	...
	for the get workforcemanagement adhocmodelingjob operation.
...
// WithDefaults hydrates default values in the get workforcemanagement adhocmodelingjob params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetWorkforcemanagementAdhocmodelingjobParams) WithDefaults() *GetWorkforcemanagementAdhocmodelingjobParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get workforcemanagement adhocmodelingjob params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetWorkforcemanagementAdhocmodelingjobParams) SetDefaults() {
