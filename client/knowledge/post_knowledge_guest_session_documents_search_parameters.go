...
PostKnowledgeGuestSessionDocumentsSearchParams contains all the parameters to send to the API endpoint
	...
	for the post knowledge guest session documents search operation.
...
// WithDefaults hydrates default values in the post knowledge guest session documents search params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostKnowledgeGuestSessionDocumentsSearchParams) WithDefaults() *PostKnowledgeGuestSessionDocumentsSearchParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the post knowledge guest session documents search params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostKnowledgeGuestSessionDocumentsSearchParams) SetDefaults() {
...
// bindParamPostKnowledgeGuestSessionDocumentsSearch binds the parameter expand
func (o *PostKnowledgeGuestSessionDocumentsSearchParams) bindParamExpand(formats strfmt.Registry) []string {
	expandIR := o.Expand
