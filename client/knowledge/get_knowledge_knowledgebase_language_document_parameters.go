...
GetKnowledgeKnowledgebaseLanguageDocumentParams contains all the parameters to send to the API endpoint
	...
	for the get knowledge knowledgebase language document operation.
...
// WithDefaults hydrates default values in the get knowledge knowledgebase language document params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetKnowledgeKnowledgebaseLanguageDocumentParams) WithDefaults() *GetKnowledgeKnowledgebaseLanguageDocumentParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get knowledge knowledgebase language document params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetKnowledgeKnowledgebaseLanguageDocumentParams) SetDefaults() {
