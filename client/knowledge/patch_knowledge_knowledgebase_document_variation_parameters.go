...
PatchKnowledgeKnowledgebaseDocumentVariationParams contains all the parameters to send to the API endpoint
	...
	for the patch knowledge knowledgebase document variation operation.
...
// WithDefaults hydrates default values in the patch knowledge knowledgebase document variation params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PatchKnowledgeKnowledgebaseDocumentVariationParams) WithDefaults() *PatchKnowledgeKnowledgebaseDocumentVariationParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the patch knowledge knowledgebase document variation params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PatchKnowledgeKnowledgebaseDocumentVariationParams) SetDefaults() {
