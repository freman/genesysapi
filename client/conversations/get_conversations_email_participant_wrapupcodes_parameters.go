...
GetConversationsEmailParticipantWrapupcodesParams contains all the parameters to send to the API endpoint
	...
	for the get conversations email participant wrapupcodes operation.
...
// WithDefaults hydrates default values in the get conversations email participant wrapupcodes params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetConversationsEmailParticipantWrapupcodesParams) WithDefaults() *GetConversationsEmailParticipantWrapupcodesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get conversations email participant wrapupcodes params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetConversationsEmailParticipantWrapupcodesParams) SetDefaults() {
