...
PatchConversationsCobrowsesessionParticipantParams contains all the parameters to send to the API endpoint
	...
	for the patch conversations cobrowsesession participant operation.
...
// WithDefaults hydrates default values in the patch conversations cobrowsesession participant params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PatchConversationsCobrowsesessionParticipantParams) WithDefaults() *PatchConversationsCobrowsesessionParticipantParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the patch conversations cobrowsesession participant params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PatchConversationsCobrowsesessionParticipantParams) SetDefaults() {
