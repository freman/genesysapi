...
GetConversationParticipantSecureivrsessionParams contains all the parameters to send to the API endpoint
	...
	for the get conversation participant secureivrsession operation.
...
// WithDefaults hydrates default values in the get conversation participant secureivrsession params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetConversationParticipantSecureivrsessionParams) WithDefaults() *GetConversationParticipantSecureivrsessionParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get conversation participant secureivrsession params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetConversationParticipantSecureivrsessionParams) SetDefaults() {
