...
GetConversationsMessagingIntegrationsWhatsappIntegrationIDParams contains all the parameters to send to the API endpoint
	...
	for the get conversations messaging integrations whatsapp integration Id operation.
...
// WithDefaults hydrates default values in the get conversations messaging integrations whatsapp integration Id params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetConversationsMessagingIntegrationsWhatsappIntegrationIDParams) WithDefaults() *GetConversationsMessagingIntegrationsWhatsappIntegrationIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get conversations messaging integrations whatsapp integration Id params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetConversationsMessagingIntegrationsWhatsappIntegrationIDParams) SetDefaults() {
