...
// bindParamGetContentmanagementWorkspaceMember binds the parameter expand
func (o *GetContentmanagementWorkspaceMemberParams) bindParamExpand(formats strfmt.Registry) []string {
	expandIR := o.Expand
