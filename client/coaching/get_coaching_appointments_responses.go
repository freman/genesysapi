...
/*GetCoachingAppointmentsOK handles this case with default header values.
...
/*GetCoachingAppointmentsBadRequest handles this case with default header values.
...
/*GetCoachingAppointmentsUnauthorized handles this case with default header values.
...
/*GetCoachingAppointmentsForbidden handles this case with default header values.
...
/*GetCoachingAppointmentsNotFound handles this case with default header values.
...
/*GetCoachingAppointmentsRequestTimeout handles this case with default header values.
...
/*GetCoachingAppointmentsUnsupportedMediaType handles this case with default header values.
...
/*GetCoachingAppointmentsTooManyRequests handles this case with default header values.
...
/*GetCoachingAppointmentsInternalServerError handles this case with default header values.
...
/*GetCoachingAppointmentsServiceUnavailable handles this case with default header values.
...
/*GetCoachingAppointmentsGatewayTimeout handles this case with default header values.
