...
GetIntegrationsSpeechTtsEnginesParams contains all the parameters to send to the API endpoint
	...
	for the get integrations speech tts engines operation.
...
// WithDefaults hydrates default values in the get integrations speech tts engines params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetIntegrationsSpeechTtsEnginesParams) WithDefaults() *GetIntegrationsSpeechTtsEnginesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get integrations speech tts engines params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetIntegrationsSpeechTtsEnginesParams) SetDefaults() {
	var (
	...
	val := GetIntegrationsSpeechTtsEnginesParams{
