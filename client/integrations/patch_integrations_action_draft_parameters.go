...
PatchIntegrationsActionDraftParams contains all the parameters to send to the API endpoint
	...
	for the patch integrations action draft operation.
...
// WithDefaults hydrates default values in the patch integrations action draft params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PatchIntegrationsActionDraftParams) WithDefaults() *PatchIntegrationsActionDraftParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the patch integrations action draft params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PatchIntegrationsActionDraftParams) SetDefaults() {
