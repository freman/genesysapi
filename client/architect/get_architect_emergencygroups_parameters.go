...
GetArchitectEmergencygroupsParams contains all the parameters to send to the API endpoint
	...
	for the get architect emergencygroups operation.
...
// WithDefaults hydrates default values in the get architect emergencygroups params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetArchitectEmergencygroupsParams) WithDefaults() *GetArchitectEmergencygroupsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get architect emergencygroups params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetArchitectEmergencygroupsParams) SetDefaults() {
	var (
	...
	val := GetArchitectEmergencygroupsParams{
