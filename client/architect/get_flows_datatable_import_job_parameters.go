...
GetFlowsDatatableImportJobParams contains all the parameters to send to the API endpoint
	...
	for the get flows datatable import job operation.
...
// WithDefaults hydrates default values in the get flows datatable import job params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetFlowsDatatableImportJobParams) WithDefaults() *GetFlowsDatatableImportJobParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get flows datatable import job params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetFlowsDatatableImportJobParams) SetDefaults() {
