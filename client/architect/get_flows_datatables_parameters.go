...
GetFlowsDatatablesParams contains all the parameters to send to the API endpoint
	...
	for the get flows datatables operation.
...
// WithDefaults hydrates default values in the get flows datatables params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetFlowsDatatablesParams) WithDefaults() *GetFlowsDatatablesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get flows datatables params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetFlowsDatatablesParams) SetDefaults() {
	var (
...
// bindParamGetFlowsDatatables binds the parameter divisionId
func (o *GetFlowsDatatablesParams) bindParamDivisionID(formats strfmt.Registry) []string {
