...
func (o *PutUserRoutingskillsBulkParams) WithTimeout(timeout time.Duration) *PutUserRoutingskillsBulkParams {
...
func (o *PutUserRoutingskillsBulkParams) WithContext(ctx context.Context) *PutUserRoutingskillsBulkParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PutUserRoutingskillsBulkParams) WithHTTPClient(client *http.Client) *PutUserRoutingskillsBulkParams {
...
func (o *PutUserRoutingskillsBulkParams) WithBody(body []*models.UserRoutingSkillPost) *PutUserRoutingskillsBulkParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the put user routingskills bulk params
func (o *PutUserRoutingskillsBulkParams) SetBody(body []*models.UserRoutingSkillPost) {
	o.Body = body
}

// WithUserID adds the userID to the put user routingskills bulk params
func (o *PutUserRoutingskillsBulkParams) WithUserID(userID string) *PutUserRoutingskillsBulkParams {
	o.SetUserID(userID)
	return o
}
...
func (o *PutUserRoutingskillsBulkParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
