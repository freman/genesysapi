...
/*PatchUsersBulkOK handles this case with default header values.
...
/*PatchUsersBulkBadRequest handles this case with default header values.
...
/*PatchUsersBulkUnauthorized handles this case with default header values.
...
/*PatchUsersBulkForbidden handles this case with default header values.
...
/*PatchUsersBulkNotFound handles this case with default header values.
...
/*PatchUsersBulkUnsupportedMediaType handles this case with default header values.
...
/*PatchUsersBulkInternalServerError handles this case with default header values.
...
/*PatchUsersBulkServiceUnavailable handles this case with default header values.
...
/*PatchUsersBulkGatewayTimeout handles this case with default header values.
