...
// NewPostUsersSearchTeamsAssignParams creates a new PostUsersSearchTeamsAssignParams object,
...
func NewPostUsersSearchTeamsAssignParams() *PostUsersSearchTeamsAssignParams {
	return &PostUsersSearchTeamsAssignParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPostUsersSearchTeamsAssignParamsWithTimeout creates a new PostUsersSearchTeamsAssignParams object
...
// NewPostUsersSearchTeamsAssignParamsWithContext creates a new PostUsersSearchTeamsAssignParams object
...
// NewPostUsersSearchTeamsAssignParamsWithHTTPClient creates a new PostUsersSearchTeamsAssignParams object
...
func (o *PostUsersSearchTeamsAssignParams) WithDefaults() *PostUsersSearchTeamsAssignParams {
	o.SetDefaults()
	return o
}
...
func (o *PostUsersSearchTeamsAssignParams) WithTimeout(timeout time.Duration) *PostUsersSearchTeamsAssignParams {
...
func (o *PostUsersSearchTeamsAssignParams) WithContext(ctx context.Context) *PostUsersSearchTeamsAssignParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the post users search teams assign params
func (o *PostUsersSearchTeamsAssignParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the post users search teams assign params
func (o *PostUsersSearchTeamsAssignParams) WithHTTPClient(client *http.Client) *PostUsersSearchTeamsAssignParams {
...
func (o *PostUsersSearchTeamsAssignParams) WithBody(body *models.UserSearchRequest) *PostUsersSearchTeamsAssignParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post users search teams assign params
func (o *PostUsersSearchTeamsAssignParams) SetBody(body *models.UserSearchRequest) {
	o.Body = body
}

// WriteToRequest writes these params to a swagger request
func (o *PostUsersSearchTeamsAssignParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
