...
/*PostAnalyticsTranscriptsAggregatesQueryOK handles this case with default header values.
...
/*PostAnalyticsTranscriptsAggregatesQueryBadRequest handles this case with default header values.
...
/*PostAnalyticsTranscriptsAggregatesQueryUnauthorized handles this case with default header values.
...
/*PostAnalyticsTranscriptsAggregatesQueryForbidden handles this case with default header values.
...
/*PostAnalyticsTranscriptsAggregatesQueryNotFound handles this case with default header values.
...
/*PostAnalyticsTranscriptsAggregatesQueryRequestTimeout handles this case with default header values.
...
/*PostAnalyticsTranscriptsAggregatesQueryRequestEntityTooLarge handles this case with default header values.
...
/*PostAnalyticsTranscriptsAggregatesQueryUnsupportedMediaType handles this case with default header values.
...
/*PostAnalyticsTranscriptsAggregatesQueryTooManyRequests handles this case with default header values.
...
/*PostAnalyticsTranscriptsAggregatesQueryInternalServerError handles this case with default header values.
...
/*PostAnalyticsTranscriptsAggregatesQueryServiceUnavailable handles this case with default header values.
...
/*PostAnalyticsTranscriptsAggregatesQueryGatewayTimeout handles this case with default header values.
