...
//
// swagger:model ResponseEntityList
...
// Validate validates this response entity list
func (m *ResponseEntityList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseEntityList) validateEntities(formats strfmt.Registry) error {
...
func (m *ResponseEntityList) validateFirstURI(formats strfmt.Registry) error {
...
func (m *ResponseEntityList) validateLastURI(formats strfmt.Registry) error {
...
func (m *ResponseEntityList) validateNextURI(formats strfmt.Registry) error {
...
func (m *ResponseEntityList) validatePreviousURI(formats strfmt.Registry) error {
...
func (m *ResponseEntityList) validateSelfURI(formats strfmt.Registry) error {
...
// ContextValidate validate this response entity list based on the context it is used
func (m *ResponseEntityList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseEntityList) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseEntityList) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseEntityList) UnmarshalBinary(b []byte) error {
	var res ResponseEntityList
