...
// ContextValidate validate this flow aggregation view based on the context it is used
func (m *FlowAggregationView) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *FlowAggregationView) contextValidateRange(ctx context.Context, formats strfmt.Registry) error {
