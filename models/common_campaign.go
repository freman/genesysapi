...
// ContextValidate validate this common campaign based on the context it is used
func (m *CommonCampaign) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CommonCampaign) contextValidateDivision(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CommonCampaign) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CommonCampaign) contextValidateSelfURI(ctx context.Context, formats strfmt.Registry) error {
