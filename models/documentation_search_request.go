...
// ContextValidate validate this documentation search request based on the context it is used
func (m *DocumentationSearchRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *DocumentationSearchRequest) contextValidateQuery(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DocumentationSearchRequest) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
