...
// ContextValidate validate this trust create based on the context it is used
func (m *TrustCreate) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TrustCreate) contextValidateGroups(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TrustCreate) contextValidateUsers(ctx context.Context, formats strfmt.Registry) error {
