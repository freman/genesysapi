...
// ContextValidate validates this date range with optional end based on context it is used
func (m *DateRangeWithOptionalEnd) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
