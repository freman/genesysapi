...
// ContextValidate validate this analytics conversation query response based on the context it is used
func (m *AnalyticsConversationQueryResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AnalyticsConversationQueryResponse) contextValidateAggregations(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AnalyticsConversationQueryResponse) contextValidateConversations(ctx context.Context, formats strfmt.Registry) error {
