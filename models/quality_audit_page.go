...
// QualityAuditPage quality audit page
//
// swagger:model QualityAuditPage
type QualityAuditPage struct {

	// entities
	Entities []*QualityAudit `json:"entities"`
...
// Validate validates this quality audit page
func (m *QualityAuditPage) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *QualityAuditPage) validateEntities(formats strfmt.Registry) error {
...
func (m *QualityAuditPage) validateFirstURI(formats strfmt.Registry) error {
...
func (m *QualityAuditPage) validateLastURI(formats strfmt.Registry) error {
...
func (m *QualityAuditPage) validateNextURI(formats strfmt.Registry) error {
...
func (m *QualityAuditPage) validatePreviousURI(formats strfmt.Registry) error {
...
func (m *QualityAuditPage) validateSelfURI(formats strfmt.Registry) error {
...
func (m *QualityAuditPage) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *QualityAuditPage) UnmarshalBinary(b []byte) error {
	var res QualityAuditPage
