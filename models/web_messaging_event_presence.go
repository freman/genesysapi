...
const (
	...
	// WebMessagingEventPresenceTypeDisconnect captures enum value "Disconnect"
	WebMessagingEventPresenceTypeDisconnect string = "Disconnect"
)
...
// ContextValidate validates this web messaging event presence based on context it is used
func (m *WebMessagingEventPresence) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
