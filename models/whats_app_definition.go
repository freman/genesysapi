...
// ContextValidate validates this whats app definition based on context it is used
func (m *WhatsAppDefinition) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
