...
// ContextValidate validate this test execution operation result based on the context it is used
func (m *TestExecutionOperationResult) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TestExecutionOperationResult) contextValidateError(ctx context.Context, formats strfmt.Registry) error {
