		...
		if m.SelectedColumns[i] != nil {
			if err := m.SelectedColumns[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("selectedColumns" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
const (
	...
	// ReportingExportJobResponseViewTypePREDICTIVEROUTINGIMPACTVIEW captures enum value "PREDICTIVE_ROUTING_IMPACT_VIEW"
	ReportingExportJobResponseViewTypePREDICTIVEROUTINGIMPACTVIEW string = "PREDICTIVE_ROUTING_IMPACT_VIEW"
	...
	// ReportingExportJobResponseViewTypeAGENTSCORECARDINSIGHTSSUMMARYVIEW captures enum value "AGENT_SCORECARD_INSIGHTS_SUMMARY_VIEW"
	ReportingExportJobResponseViewTypeAGENTSCORECARDINSIGHTSSUMMARYVIEW string = "AGENT_SCORECARD_INSIGHTS_SUMMARY_VIEW"

	// ReportingExportJobResponseViewTypeAGENTSCORECARDINSIGHTSDETAILVIEW captures enum value "AGENT_SCORECARD_INSIGHTS_DETAIL_VIEW"
	ReportingExportJobResponseViewTypeAGENTSCORECARDINSIGHTSDETAILVIEW string = "AGENT_SCORECARD_INSIGHTS_DETAIL_VIEW"

	// ReportingExportJobResponseViewTypeQUEUEWRAPUPDETAILVIEW captures enum value "QUEUE_WRAPUP_DETAIL_VIEW"
	ReportingExportJobResponseViewTypeQUEUEWRAPUPDETAILVIEW string = "QUEUE_WRAPUP_DETAIL_VIEW"

	// ReportingExportJobResponseViewTypeINTERACTIONDETAILVIEW captures enum value "INTERACTION_DETAIL_VIEW"
	ReportingExportJobResponseViewTypeINTERACTIONDETAILVIEW string = "INTERACTION_DETAIL_VIEW"

	// ReportingExportJobResponseViewTypeCAMPAIGNINTERACTIONDETAILVIEW captures enum value "CAMPAIGN_INTERACTION_DETAIL_VIEW"
	ReportingExportJobResponseViewTypeCAMPAIGNINTERACTIONDETAILVIEW string = "CAMPAIGN_INTERACTION_DETAIL_VIEW"

	// ReportingExportJobResponseViewTypeCAMPAIGNATTEMPTDETAILVIEW captures enum value "CAMPAIGN_ATTEMPT_DETAIL_VIEW"
	ReportingExportJobResponseViewTypeCAMPAIGNATTEMPTDETAILVIEW string = "CAMPAIGN_ATTEMPT_DETAIL_VIEW"

	// ReportingExportJobResponseViewTypeWORKITEMPERFORMANCESUMMARYVIEW captures enum value "WORKITEM_PERFORMANCE_SUMMARY_VIEW"
	ReportingExportJobResponseViewTypeWORKITEMPERFORMANCESUMMARYVIEW string = "WORKITEM_PERFORMANCE_SUMMARY_VIEW"
)
...
// ContextValidate validate this reporting export job response based on the context it is used
func (m *ReportingExportJobResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
	...
	if err := m.contextValidateSelectedColumns(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *ReportingExportJobResponse) contextValidateFilter(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReportingExportJobResponse) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReportingExportJobResponse) contextValidateSelectedColumns(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.SelectedColumns); i++ {

		if m.SelectedColumns[i] != nil {
			if err := m.SelectedColumns[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("selectedColumns" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("selectedColumns" + "." + strconv.Itoa(i))
...
func (m *ReportingExportJobResponse) contextValidateSelfURI(ctx context.Context, formats strfmt.Registry) error {
