...
// ContextValidate validates this line status based on context it is used
func (m *LineStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
