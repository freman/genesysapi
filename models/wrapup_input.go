...
// WrapupInput wrapup input
//
// swagger:model WrapupInput
...
// Validate validates this wrapup input
func (m *WrapupInput) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *WrapupInput) validateEndTime(formats strfmt.Registry) error {
...
// ContextValidate validates this wrapup input based on context it is used
func (m *WrapupInput) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *WrapupInput) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *WrapupInput) UnmarshalBinary(b []byte) error {
	var res WrapupInput
