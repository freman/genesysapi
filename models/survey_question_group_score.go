...
// ContextValidate validate this survey question group score based on the context it is used
func (m *SurveyQuestionGroupScore) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SurveyQuestionGroupScore) contextValidateQuestionScores(ctx context.Context, formats strfmt.Registry) error {
