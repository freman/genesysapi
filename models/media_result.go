...
// ContextValidate validates this media result based on context it is used
func (m *MediaResult) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
