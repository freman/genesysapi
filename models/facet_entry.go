...
// ContextValidate validate this facet entry based on the context it is used
func (m *FacetEntry) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *FacetEntry) contextValidateAttribute(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FacetEntry) contextValidateStatistics(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FacetEntry) contextValidateTerms(ctx context.Context, formats strfmt.Registry) error {
