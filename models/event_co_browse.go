...
// ContextValidate validates this event co browse based on context it is used
func (m *EventCoBrowse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
