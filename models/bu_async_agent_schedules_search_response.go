...
// ContextValidate validate this bu async agent schedules search response based on the context it is used
func (m *BuAsyncAgentSchedulesSearchResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *BuAsyncAgentSchedulesSearchResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
