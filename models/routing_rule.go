...
// ContextValidate validates this routing rule based on context it is used
func (m *RoutingRule) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
