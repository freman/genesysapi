...
// ContextValidate validate this knowledge document suggestion based on the context it is used
func (m *KnowledgeDocumentSuggestion) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *KnowledgeDocumentSuggestion) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "results", "body", []*KnowledgeDocumentSuggestionResult(m.Results)); err != nil {
		return err
	}
