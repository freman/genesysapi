...
// ContextValidate validate this transcript conversation detail search criteria based on the context it is used
func (m *TranscriptConversationDetailSearchCriteria) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TranscriptConversationDetailSearchCriteria) contextValidateGroup(ctx context.Context, formats strfmt.Registry) error {
