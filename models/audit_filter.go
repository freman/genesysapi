...
// ContextValidate validates this audit filter based on context it is used
func (m *AuditFilter) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
