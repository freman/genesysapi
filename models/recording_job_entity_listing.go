...
// ContextValidate validate this recording job entity listing based on the context it is used
func (m *RecordingJobEntityListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RecordingJobEntityListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
