...
// ContextValidate validate this query request filter based on the context it is used
func (m *QueryRequestFilter) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *QueryRequestFilter) contextValidateClauses(ctx context.Context, formats strfmt.Registry) error {
