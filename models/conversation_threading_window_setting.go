...
// ContextValidate validates this conversation threading window setting based on context it is used
func (m *ConversationThreadingWindowSetting) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
