...
// ContextValidate validates this reporting turn intent slot based on context it is used
func (m *ReportingTurnIntentSlot) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
