...
// ContextValidate validate this ping identity based on the context it is used
func (m *PingIdentity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PingIdentity) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PingIdentity) contextValidateSelfURI(ctx context.Context, formats strfmt.Registry) error {
