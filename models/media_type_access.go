		...
		if m.Inbound[i] != nil {
			if err := m.Inbound[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("inbound" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.Outbound[i] != nil {
			if err := m.Outbound[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("outbound" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
// ContextValidate validate this media type access based on the context it is used
func (m *MediaTypeAccess) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *MediaTypeAccess) contextValidateInbound(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.Inbound); i++ {

		if m.Inbound[i] != nil {
			if err := m.Inbound[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("inbound" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("inbound" + "." + strconv.Itoa(i))
...
func (m *MediaTypeAccess) contextValidateOutbound(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.Outbound); i++ {

		if m.Outbound[i] != nil {
			if err := m.Outbound[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("outbound" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("outbound" + "." + strconv.Itoa(i))
