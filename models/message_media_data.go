...
// ContextValidate validate this message media data based on the context it is used
func (m *MessageMediaData) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *MessageMediaData) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MessageMediaData) contextValidateSelfURI(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MessageMediaData) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
