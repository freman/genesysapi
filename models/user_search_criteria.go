...
// ContextValidate validate this user search criteria based on the context it is used
func (m *UserSearchCriteria) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *UserSearchCriteria) contextValidateGroup(ctx context.Context, formats strfmt.Registry) error {
