...
// ContextValidate validate this chat message user based on the context it is used
func (m *ChatMessageUser) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ChatMessageUser) contextValidateImages(ctx context.Context, formats strfmt.Registry) error {
