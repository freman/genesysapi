...
// DocumentVariation document variation
//
// swagger:model DocumentVariation
...
// Validate validates this document variation
func (m *DocumentVariation) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DocumentVariation) validateContexts(formats strfmt.Registry) error {
...
func (m *DocumentVariation) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *DocumentVariation) UnmarshalBinary(b []byte) error {
	var res DocumentVariation
