...
// ContextValidate validate this audit realtime query results response based on the context it is used
func (m *AuditRealtimeQueryResultsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AuditRealtimeQueryResultsResponse) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
