...
// NluDomainListing nlu domain listing
//
// swagger:model NluDomainListing
...
// Validate validates this nlu domain listing
func (m *NluDomainListing) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NluDomainListing) validateEntities(formats strfmt.Registry) error {
...
func (m *NluDomainListing) validateFirstURI(formats strfmt.Registry) error {
...
func (m *NluDomainListing) validateLastURI(formats strfmt.Registry) error {
...
func (m *NluDomainListing) validateNextURI(formats strfmt.Registry) error {
...
func (m *NluDomainListing) validatePreviousURI(formats strfmt.Registry) error {
...
func (m *NluDomainListing) validateSelfURI(formats strfmt.Registry) error {
...
// ContextValidate validate this nlu domain listing based on the context it is used
func (m *NluDomainListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NluDomainListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NluDomainListing) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NluDomainListing) UnmarshalBinary(b []byte) error {
	var res NluDomainListing
