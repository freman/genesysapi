...
// RecipientListing recipient listing
//
// swagger:model RecipientListing
...
// Validate validates this recipient listing
func (m *RecipientListing) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RecipientListing) validateEntities(formats strfmt.Registry) error {
...
func (m *RecipientListing) validateFirstURI(formats strfmt.Registry) error {
...
func (m *RecipientListing) validateLastURI(formats strfmt.Registry) error {
...
func (m *RecipientListing) validateNextURI(formats strfmt.Registry) error {
...
func (m *RecipientListing) validatePreviousURI(formats strfmt.Registry) error {
...
func (m *RecipientListing) validateSelfURI(formats strfmt.Registry) error {
...
// ContextValidate validate this recipient listing based on the context it is used
func (m *RecipientListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RecipientListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecipientListing) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RecipientListing) UnmarshalBinary(b []byte) error {
	var res RecipientListing
