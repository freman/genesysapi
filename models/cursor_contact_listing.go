...
func (m *CursorContactListing) validateCursors(formats strfmt.Registry) error {
...
// ContextValidate validate this cursor contact listing based on the context it is used
func (m *CursorContactListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CursorContactListing) contextValidateCursors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CursorContactListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
