...
// ContextValidate validate this scim v2 group reference based on the context it is used
func (m *ScimV2GroupReference) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ScimV2GroupReference) contextValidateDollarRef(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ScimV2GroupReference) contextValidateType(ctx context.Context, formats strfmt.Registry) error {
