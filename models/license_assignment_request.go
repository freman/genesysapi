...
// ContextValidate validates this license assignment request based on context it is used
func (m *LicenseAssignmentRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
