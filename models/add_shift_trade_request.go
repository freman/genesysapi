...
// ContextValidate validates this add shift trade request based on context it is used
func (m *AddShiftTradeRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
