...
// ContextValidate validate this knowledge guest session context based on the context it is used
func (m *KnowledgeGuestSessionContext) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *KnowledgeGuestSessionContext) contextValidateValues(ctx context.Context, formats strfmt.Registry) error {
