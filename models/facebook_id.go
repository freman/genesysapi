...
// ContextValidate validate this facebook Id based on the context it is used
func (m *FacebookID) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *FacebookID) contextValidateIds(ctx context.Context, formats strfmt.Registry) error {
