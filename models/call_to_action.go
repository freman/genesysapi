...
// ContextValidate validates this call to action based on context it is used
func (m *CallToAction) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
