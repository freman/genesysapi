...
// ContextValidate validate this queue observation query predicate based on the context it is used
func (m *QueueObservationQueryPredicate) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *QueueObservationQueryPredicate) contextValidateRange(ctx context.Context, formats strfmt.Registry) error {
