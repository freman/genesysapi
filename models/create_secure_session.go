...
// ContextValidate validates this create secure session based on context it is used
func (m *CreateSecureSession) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
