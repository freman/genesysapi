...
// ContextValidate validates this phrase associations based on context it is used
func (m *PhraseAssociations) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
