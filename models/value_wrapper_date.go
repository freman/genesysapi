...
// ContextValidate validates this value wrapper date based on context it is used
func (m *ValueWrapperDate) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
