...
// ContextValidate validates this long term forecast planning group data based on context it is used
func (m *LongTermForecastPlanningGroupData) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
