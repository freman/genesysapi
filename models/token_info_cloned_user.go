...
// ContextValidate validate this token info cloned user based on the context it is used
func (m *TokenInfoClonedUser) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TokenInfoClonedUser) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenInfoClonedUser) contextValidateOrganization(ctx context.Context, formats strfmt.Registry) error {
