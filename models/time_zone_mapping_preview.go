...
// ContextValidate validate this time zone mapping preview based on the context it is used
func (m *TimeZoneMappingPreview) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TimeZoneMappingPreview) contextValidateContactList(ctx context.Context, formats strfmt.Registry) error {
