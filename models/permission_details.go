...
// ContextValidate validates this permission details based on context it is used
func (m *PermissionDetails) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
