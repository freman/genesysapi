...
type EventLog struct {
	...
	// category
	// Enum: [CALLBACK CALL_RESTRICTION CALL_RULE CAMPAIGN CAMPAIGN_RULE CONTACT CONTACT_LIST_FILTER DNC_LIST ENTITY_LIMIT IMPORT_ERROR MESSAGE_RESTRICTION MESSAGING_CAMPAIGN ORGANIZATION_CONFIGURATION SCHEDULE]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["CALLBACK","CALL_RESTRICTION","CALL_RULE","CAMPAIGN","CAMPAIGN_RULE","CONTACT","CONTACT_LIST_FILTER","DNC_LIST","ENTITY_LIMIT","IMPORT_ERROR","MESSAGE_RESTRICTION","MESSAGING_CAMPAIGN","ORGANIZATION_CONFIGURATION","SCHEDULE"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
