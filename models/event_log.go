...
type EventLog struct {
	...
	// category
	// Enum: [CALLBACK CALL_RESTRICTION CALL_RULE CAMPAIGN CAMPAIGN_RULE CONTACT CONTACT_LIST_FILTER DIGITAL_RULE DNC_LIST ENTITY_LIMIT IMPORT_ERROR MESSAGE_RESTRICTION MESSAGING_CAMPAIGN ORGANIZATION_CONFIGURATION SCHEDULE MESSAGING_CAMPAIGN_SCHEDULE EMAIL_CAMPAIGN_SCHEDULE]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["CALLBACK","CALL_RESTRICTION","CALL_RULE","CAMPAIGN","CAMPAIGN_RULE","CONTACT","CONTACT_LIST_FILTER","DIGITAL_RULE","DNC_LIST","ENTITY_LIMIT","IMPORT_ERROR","MESSAGE_RESTRICTION","MESSAGING_CAMPAIGN","ORGANIZATION_CONFIGURATION","SCHEDULE","MESSAGING_CAMPAIGN_SCHEDULE","EMAIL_CAMPAIGN_SCHEDULE"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// EventLogCategoryDIGITALRULE captures enum value "DIGITAL_RULE"
	EventLogCategoryDIGITALRULE string = "DIGITAL_RULE"
	...
	// EventLogCategoryMESSAGERESTRICTION captures enum value "MESSAGE_RESTRICTION"
	EventLogCategoryMESSAGERESTRICTION string = "MESSAGE_RESTRICTION"
	...
	// EventLogCategoryMESSAGINGCAMPAIGNSCHEDULE captures enum value "MESSAGING_CAMPAIGN_SCHEDULE"
	EventLogCategoryMESSAGINGCAMPAIGNSCHEDULE string = "MESSAGING_CAMPAIGN_SCHEDULE"

	// EventLogCategoryEMAILCAMPAIGNSCHEDULE captures enum value "EMAIL_CAMPAIGN_SCHEDULE"
	EventLogCategoryEMAILCAMPAIGNSCHEDULE string = "EMAIL_CAMPAIGN_SCHEDULE"
)
