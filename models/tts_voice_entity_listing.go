...
// ContextValidate validate this tts voice entity listing based on the context it is used
func (m *TtsVoiceEntityListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TtsVoiceEntityListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
