...
// ContextValidate validate this bot search response based on the context it is used
func (m *BotSearchResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *BotSearchResponse) contextValidateSelfURI(ctx context.Context, formats strfmt.Registry) error {
