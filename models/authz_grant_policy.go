...
// ContextValidate validates this authz grant policy based on context it is used
func (m *AuthzGrantPolicy) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
