...
// ContextValidate validates this conversation properties based on context it is used
func (m *ConversationProperties) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
