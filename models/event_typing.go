...
// ContextValidate validate this event typing based on the context it is used
func (m *EventTyping) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *EventTyping) contextValidateDuration(ctx context.Context, formats strfmt.Registry) error {
