...
type Edge struct {
	...
	// Enum: [HARDWARE LDM CDM CHS INVALID]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["HARDWARE","LDM","CDM","CHS","INVALID"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// EdgeEdgeDeploymentTypeCHS captures enum value "CHS"
	EdgeEdgeDeploymentTypeCHS string = "CHS"
