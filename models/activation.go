...
func (m *Activation) validateType(formats strfmt.Registry) error {
...
// ContextValidate validates this activation based on context it is used
func (m *Activation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
