...
// UserEntityListing user entity listing
//
// swagger:model UserEntityListing
...
// Validate validates this user entity listing
func (m *UserEntityListing) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UserEntityListing) validateEntities(formats strfmt.Registry) error {
...
func (m *UserEntityListing) validateFirstURI(formats strfmt.Registry) error {
...
func (m *UserEntityListing) validateLastURI(formats strfmt.Registry) error {
...
func (m *UserEntityListing) validateNextURI(formats strfmt.Registry) error {
...
func (m *UserEntityListing) validatePreviousURI(formats strfmt.Registry) error {
...
func (m *UserEntityListing) validateSelfURI(formats strfmt.Registry) error {
...
// ContextValidate validate this user entity listing based on the context it is used
func (m *UserEntityListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *UserEntityListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UserEntityListing) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *UserEntityListing) UnmarshalBinary(b []byte) error {
	var res UserEntityListing
