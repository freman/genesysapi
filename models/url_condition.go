...
// ContextValidate validates this Url condition based on context it is used
func (m *URLCondition) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
