...
func (m *OpenNormalizedMessage) validateEvents(formats strfmt.Registry) error {
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["Text","Receipt","Event"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// OpenNormalizedMessageTypeEvent captures enum value "Event"
	OpenNormalizedMessageTypeEvent string = "Event"
)
