...
// ContextValidate validates this user image based on context it is used
func (m *UserImage) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
