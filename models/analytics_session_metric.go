...
// ContextValidate validates this analytics session metric based on context it is used
func (m *AnalyticsSessionMetric) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
