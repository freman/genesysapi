...
// ContextValidate validate this bulk response result note note based on the context it is used
func (m *BulkResponseResultNoteNote) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *BulkResponseResultNoteNote) contextValidateEntity(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BulkResponseResultNoteNote) contextValidateError(ctx context.Context, formats strfmt.Registry) error {
