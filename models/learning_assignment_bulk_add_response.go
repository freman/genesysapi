...
// LearningAssignmentBulkAddResponse learning assignment bulk add response
//
// swagger:model LearningAssignmentBulkAddResponse
...
// Validate validates this learning assignment bulk add response
func (m *LearningAssignmentBulkAddResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LearningAssignmentBulkAddResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *LearningAssignmentBulkAddResponse) UnmarshalBinary(b []byte) error {
	var res LearningAssignmentBulkAddResponse
