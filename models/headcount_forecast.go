		...
		if m.Required[i] != nil {
			if err := m.Required[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("required" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.RequiredWithoutShrinkage[i] != nil {
			if err := m.RequiredWithoutShrinkage[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("requiredWithoutShrinkage" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
// ContextValidate validate this headcount forecast based on the context it is used
func (m *HeadcountForecast) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
	...
	if err := m.contextValidateRequiredWithoutShrinkage(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *HeadcountForecast) contextValidateRequired(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.Required); i++ {

		if m.Required[i] != nil {
			if err := m.Required[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("required" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("required" + "." + strconv.Itoa(i))
...
func (m *HeadcountForecast) contextValidateRequiredWithoutShrinkage(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.RequiredWithoutShrinkage); i++ {

		if m.RequiredWithoutShrinkage[i] != nil {
			if err := m.RequiredWithoutShrinkage[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("requiredWithoutShrinkage" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("requiredWithoutShrinkage" + "." + strconv.Itoa(i))
