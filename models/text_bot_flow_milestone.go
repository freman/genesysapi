...
// ContextValidate validates this text bot flow milestone based on context it is used
func (m *TextBotFlowMilestone) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
