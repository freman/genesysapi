...
// FlowEntityListing flow entity listing
//
// swagger:model FlowEntityListing
...
// Validate validates this flow entity listing
func (m *FlowEntityListing) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *FlowEntityListing) validateEntities(formats strfmt.Registry) error {
...
func (m *FlowEntityListing) validateFirstURI(formats strfmt.Registry) error {
...
func (m *FlowEntityListing) validateLastURI(formats strfmt.Registry) error {
...
func (m *FlowEntityListing) validateNextURI(formats strfmt.Registry) error {
...
func (m *FlowEntityListing) validatePreviousURI(formats strfmt.Registry) error {
...
func (m *FlowEntityListing) validateSelfURI(formats strfmt.Registry) error {
...
// ContextValidate validate this flow entity listing based on the context it is used
func (m *FlowEntityListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *FlowEntityListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FlowEntityListing) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *FlowEntityListing) UnmarshalBinary(b []byte) error {
	var res FlowEntityListing
