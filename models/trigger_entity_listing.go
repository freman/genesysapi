...
// ContextValidate validate this trigger entity listing based on the context it is used
func (m *TriggerEntityListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TriggerEntityListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
