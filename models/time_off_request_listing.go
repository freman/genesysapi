...
// ContextValidate validate this time off request listing based on the context it is used
func (m *TimeOffRequestListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TimeOffRequestListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
