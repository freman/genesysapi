...
// ContextValidate validate this bu forecast result response based on the context it is used
func (m *BuForecastResultResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *BuForecastResultResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
