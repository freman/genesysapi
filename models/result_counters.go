...
// ContextValidate validates this result counters based on context it is used
func (m *ResultCounters) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
