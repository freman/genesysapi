...
// ContextValidate validates this learning module rule parts based on context it is used
func (m *LearningModuleRuleParts) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
