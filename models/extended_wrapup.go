...
// ExtendedWrapup extended wrapup
//
// swagger:model ExtendedWrapup
...
// Validate validates this extended wrapup
func (m *ExtendedWrapup) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ExtendedWrapup) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ExtendedWrapup) UnmarshalBinary(b []byte) error {
	var res ExtendedWrapup
