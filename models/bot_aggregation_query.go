...
// ContextValidate validate this bot aggregation query based on the context it is used
func (m *BotAggregationQuery) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *BotAggregationQuery) contextValidateFilter(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BotAggregationQuery) contextValidateViews(ctx context.Context, formats strfmt.Registry) error {
