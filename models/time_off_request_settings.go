...
// ContextValidate validates this time off request settings based on context it is used
func (m *TimeOffRequestSettings) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
