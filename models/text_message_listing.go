...
// TextMessageListing text message listing
//
// swagger:model TextMessageListing
...
// Validate validates this text message listing
func (m *TextMessageListing) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TextMessageListing) validateEntities(formats strfmt.Registry) error {
...
func (m *TextMessageListing) validateFirstURI(formats strfmt.Registry) error {
...
func (m *TextMessageListing) validateLastURI(formats strfmt.Registry) error {
...
func (m *TextMessageListing) validateNextURI(formats strfmt.Registry) error {
...
func (m *TextMessageListing) validatePreviousURI(formats strfmt.Registry) error {
...
func (m *TextMessageListing) validateSelfURI(formats strfmt.Registry) error {
...
// ContextValidate validate this text message listing based on the context it is used
func (m *TextMessageListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TextMessageListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TextMessageListing) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TextMessageListing) UnmarshalBinary(b []byte) error {
	var res TextMessageListing
