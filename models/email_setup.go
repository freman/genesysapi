...
// ContextValidate validates this email setup based on context it is used
func (m *EmailSetup) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
