...
// ContextValidate validate this coaching appointment status response list based on the context it is used
func (m *CoachingAppointmentStatusResponseList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CoachingAppointmentStatusResponseList) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
