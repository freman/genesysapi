...
// ContextValidate validates this g d p r journey customer based on context it is used
func (m *GDPRJourneyCustomer) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
