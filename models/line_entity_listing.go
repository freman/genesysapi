...
// LineEntityListing line entity listing
//
// swagger:model LineEntityListing
...
// Validate validates this line entity listing
func (m *LineEntityListing) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LineEntityListing) validateEntities(formats strfmt.Registry) error {
...
func (m *LineEntityListing) validateFirstURI(formats strfmt.Registry) error {
...
func (m *LineEntityListing) validateLastURI(formats strfmt.Registry) error {
...
func (m *LineEntityListing) validateNextURI(formats strfmt.Registry) error {
...
func (m *LineEntityListing) validatePreviousURI(formats strfmt.Registry) error {
...
func (m *LineEntityListing) validateSelfURI(formats strfmt.Registry) error {
...
// ContextValidate validate this line entity listing based on the context it is used
func (m *LineEntityListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *LineEntityListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LineEntityListing) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *LineEntityListing) UnmarshalBinary(b []byte) error {
	var res LineEntityListing
