...
// ContextValidate validates this fax status based on context it is used
func (m *FaxStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
