...
// ContextValidate validate this dependency type based on the context it is used
...
func (m *DependencyType) contextValidateSelfURI(ctx context.Context, formats strfmt.Registry) error {
