...
// ContextValidate validates this localized labels based on context it is used
func (m *LocalizedLabels) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
