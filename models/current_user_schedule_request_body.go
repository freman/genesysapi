...
// ContextValidate validates this current user schedule request body based on context it is used
func (m *CurrentUserScheduleRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
