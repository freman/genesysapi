...
// ContextValidate validates this selector event trigger based on context it is used
func (m *SelectorEventTrigger) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
