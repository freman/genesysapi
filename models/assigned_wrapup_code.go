...
// ContextValidate validates this assigned wrapup code based on context it is used
func (m *AssignedWrapupCode) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
