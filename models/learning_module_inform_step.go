...
type LearningModuleInformStep struct {
	...
	// Required: true
	// Enum: [Url Content GenesysBuiltInCourse RichText Scorm]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["Url","Content","GenesysBuiltInCourse","RichText","Scorm"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// LearningModuleInformStepTypeScorm captures enum value "Scorm"
	LearningModuleInformStepTypeScorm string = "Scorm"
)
...
// ContextValidate validates this learning module inform step based on context it is used
func (m *LearningModuleInformStep) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
