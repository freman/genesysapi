...
// DIDEntityListing d ID entity listing
//
// swagger:model DIDEntityListing
...
// Validate validates this d ID entity listing
func (m *DIDEntityListing) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DIDEntityListing) validateEntities(formats strfmt.Registry) error {
...
func (m *DIDEntityListing) validateFirstURI(formats strfmt.Registry) error {
...
func (m *DIDEntityListing) validateLastURI(formats strfmt.Registry) error {
...
func (m *DIDEntityListing) validateNextURI(formats strfmt.Registry) error {
...
func (m *DIDEntityListing) validatePreviousURI(formats strfmt.Registry) error {
...
func (m *DIDEntityListing) validateSelfURI(formats strfmt.Registry) error {
...
// ContextValidate validate this d ID entity listing based on the context it is used
func (m *DIDEntityListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *DIDEntityListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DIDEntityListing) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *DIDEntityListing) UnmarshalBinary(b []byte) error {
	var res DIDEntityListing
