...
// ContextValidate validate this training listing based on the context it is used
func (m *TrainingListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TrainingListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
