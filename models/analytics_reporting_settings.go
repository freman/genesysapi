...
// ContextValidate validates this analytics reporting settings based on context it is used
func (m *AnalyticsReportingSettings) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
