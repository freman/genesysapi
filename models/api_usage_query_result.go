...
// ContextValidate validate this Api usage query result based on the context it is used
func (m *APIUsageQueryResult) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *APIUsageQueryResult) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
