...
// ContextValidate validate this sms address based on the context it is used
func (m *SmsAddress) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SmsAddress) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SmsAddress) contextValidateSelfURI(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SmsAddress) contextValidateValidated(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "validated", "body", m.Validated); err != nil {
		return err
	}
