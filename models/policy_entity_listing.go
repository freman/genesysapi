...
// ContextValidate validate this policy entity listing based on the context it is used
func (m *PolicyEntityListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PolicyEntityListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
