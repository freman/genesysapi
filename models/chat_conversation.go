...
//
// swagger:model ChatConversation
...
// Validate validates this chat conversation
func (m *ChatConversation) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ChatConversation) validateOtherMediaUris(formats strfmt.Registry) error {
...
func (m *ChatConversation) validateParticipants(formats strfmt.Registry) error {
...
func (m *ChatConversation) validateRecentTransfers(formats strfmt.Registry) error {
...
func (m *ChatConversation) validateSelfURI(formats strfmt.Registry) error {
...
// ContextValidate validate this chat conversation based on the context it is used
func (m *ChatConversation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ChatConversation) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ChatConversation) contextValidateParticipants(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ChatConversation) contextValidateRecentTransfers(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ChatConversation) contextValidateSelfURI(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ChatConversation) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ChatConversation) UnmarshalBinary(b []byte) error {
	var res ChatConversation
