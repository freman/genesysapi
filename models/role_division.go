...
// ContextValidate validates this role division based on context it is used
func (m *RoleDivision) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
