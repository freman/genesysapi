...
// OutcomeListing outcome listing
//
// swagger:model OutcomeListing
...
// Validate validates this outcome listing
func (m *OutcomeListing) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OutcomeListing) validateEntities(formats strfmt.Registry) error {
...
func (m *OutcomeListing) validateFirstURI(formats strfmt.Registry) error {
...
func (m *OutcomeListing) validateLastURI(formats strfmt.Registry) error {
...
func (m *OutcomeListing) validateNextURI(formats strfmt.Registry) error {
...
func (m *OutcomeListing) validatePreviousURI(formats strfmt.Registry) error {
...
func (m *OutcomeListing) validateSelfURI(formats strfmt.Registry) error {
...
// ContextValidate validate this outcome listing based on the context it is used
func (m *OutcomeListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OutcomeListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OutcomeListing) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OutcomeListing) UnmarshalBinary(b []byte) error {
	var res OutcomeListing
