...
// ContextValidate validates this speech text analytics settings request based on context it is used
func (m *SpeechTextAnalyticsSettingsRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
