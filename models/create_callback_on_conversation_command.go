...
// CreateCallbackOnConversationCommand create callback on conversation command
//
// swagger:model CreateCallbackOnConversationCommand
...
// Validate validates this create callback on conversation command
func (m *CreateCallbackOnConversationCommand) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateCallbackOnConversationCommand) validateCallbackNumbers(formats strfmt.Registry) error {
...
func (m *CreateCallbackOnConversationCommand) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateCallbackOnConversationCommand) UnmarshalBinary(b []byte) error {
	var res CreateCallbackOnConversationCommand
