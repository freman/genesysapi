...
// ContextValidate validate this intent feedback based on the context it is used
func (m *IntentFeedback) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IntentFeedback) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IntentFeedback) contextValidateName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IntentFeedback) contextValidateProbability(ctx context.Context, formats strfmt.Registry) error {
