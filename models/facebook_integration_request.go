...
// ContextValidate validate this facebook integration request based on the context it is used
func (m *FacebookIntegrationRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *FacebookIntegrationRequest) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FacebookIntegrationRequest) contextValidateMessagingSetting(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FacebookIntegrationRequest) contextValidateSelfURI(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FacebookIntegrationRequest) contextValidateSupportedContent(ctx context.Context, formats strfmt.Registry) error {
