...
// Validate validates this system prompt
func (m *SystemPrompt) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SystemPrompt) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SystemPrompt) UnmarshalBinary(b []byte) error {
