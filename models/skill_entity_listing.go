...
// SkillEntityListing skill entity listing
//
// swagger:model SkillEntityListing
...
// Validate validates this skill entity listing
func (m *SkillEntityListing) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SkillEntityListing) validateEntities(formats strfmt.Registry) error {
...
func (m *SkillEntityListing) validateFirstURI(formats strfmt.Registry) error {
...
func (m *SkillEntityListing) validateLastURI(formats strfmt.Registry) error {
...
func (m *SkillEntityListing) validateNextURI(formats strfmt.Registry) error {
...
func (m *SkillEntityListing) validatePreviousURI(formats strfmt.Registry) error {
...
func (m *SkillEntityListing) validateSelfURI(formats strfmt.Registry) error {
...
// ContextValidate validate this skill entity listing based on the context it is used
func (m *SkillEntityListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SkillEntityListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SkillEntityListing) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SkillEntityListing) UnmarshalBinary(b []byte) error {
	var res SkillEntityListing
