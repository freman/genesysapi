...
func (m *Metabase) validateDivision(formats strfmt.Registry) error {
...
// ContextValidate validate this metabase based on the context it is used
func (m *Metabase) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Metabase) contextValidateCreatedBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Metabase) contextValidateCreatedByApp(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Metabase) contextValidateDateCreated(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Metabase) contextValidateDateModified(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Metabase) contextValidateDivision(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Metabase) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Metabase) contextValidateModifiedBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Metabase) contextValidateModifiedByApp(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Metabase) contextValidateSelfURI(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Metabase) contextValidateState(ctx context.Context, formats strfmt.Registry) error {
