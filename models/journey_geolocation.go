...
// ContextValidate validates this journey geolocation based on context it is used
func (m *JourneyGeolocation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
