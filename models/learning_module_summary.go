...
// ContextValidate validates this learning module summary based on context it is used
func (m *LearningModuleSummary) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
