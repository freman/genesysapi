...
// ContextValidate validate this journey aggregate query clause based on the context it is used
func (m *JourneyAggregateQueryClause) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *JourneyAggregateQueryClause) contextValidatePredicates(ctx context.Context, formats strfmt.Registry) error {
