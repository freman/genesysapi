...
// ContextValidate validate this query request clause based on the context it is used
func (m *QueryRequestClause) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *QueryRequestClause) contextValidatePredicates(ctx context.Context, formats strfmt.Registry) error {
