...
// ContextValidate validate this s IP search public request based on the context it is used
func (m *SIPSearchPublicRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SIPSearchPublicRequest) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SIPSearchPublicRequest) contextValidateSelfURI(ctx context.Context, formats strfmt.Registry) error {
