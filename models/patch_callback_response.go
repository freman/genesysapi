...
// ContextValidate validate this patch callback response based on the context it is used
func (m *PatchCallbackResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PatchCallbackResponse) contextValidateCallbackIdentifiers(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PatchCallbackResponse) contextValidateConversation(ctx context.Context, formats strfmt.Registry) error {
