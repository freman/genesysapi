...
// ContextValidate validates this edge network diagnostic request based on context it is used
func (m *EdgeNetworkDiagnosticRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
