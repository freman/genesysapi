...
// ContextValidate validate this voicemail search criteria based on the context it is used
func (m *VoicemailSearchCriteria) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *VoicemailSearchCriteria) contextValidateGroup(ctx context.Context, formats strfmt.Registry) error {
