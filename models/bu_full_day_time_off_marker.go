...
// ContextValidate validates this bu full day time off marker based on context it is used
func (m *BuFullDayTimeOffMarker) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
