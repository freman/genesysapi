...
// ContextValidate validates this patch user based on context it is used
func (m *PatchUser) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
