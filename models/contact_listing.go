...
// ContactListing contact listing
//
// swagger:model ContactListing
...
// Validate validates this contact listing
func (m *ContactListing) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ContactListing) validateEntities(formats strfmt.Registry) error {
...
func (m *ContactListing) validateFirstURI(formats strfmt.Registry) error {
...
func (m *ContactListing) validateLastURI(formats strfmt.Registry) error {
...
func (m *ContactListing) validateNextURI(formats strfmt.Registry) error {
...
func (m *ContactListing) validatePreviousURI(formats strfmt.Registry) error {
...
func (m *ContactListing) validateSelfURI(formats strfmt.Registry) error {
...
// ContextValidate validate this contact listing based on the context it is used
func (m *ContactListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ContactListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ContactListing) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContactListing) UnmarshalBinary(b []byte) error {
	var res ContactListing
