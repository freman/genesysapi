...
// SegmentListing segment listing
//
// swagger:model SegmentListing
...
// Validate validates this segment listing
func (m *SegmentListing) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SegmentListing) validateEntities(formats strfmt.Registry) error {
...
func (m *SegmentListing) validateFirstURI(formats strfmt.Registry) error {
...
func (m *SegmentListing) validateLastURI(formats strfmt.Registry) error {
...
func (m *SegmentListing) validateNextURI(formats strfmt.Registry) error {
...
func (m *SegmentListing) validatePreviousURI(formats strfmt.Registry) error {
...
func (m *SegmentListing) validateSelfURI(formats strfmt.Registry) error {
...
// ContextValidate validate this segment listing based on the context it is used
func (m *SegmentListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SegmentListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SegmentListing) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SegmentListing) UnmarshalBinary(b []byte) error {
	var res SegmentListing
