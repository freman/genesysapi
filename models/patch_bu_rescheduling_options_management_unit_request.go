...
// ContextValidate validates this patch bu rescheduling options management unit request based on context it is used
func (m *PatchBuReschedulingOptionsManagementUnitRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
