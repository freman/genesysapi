...
// ContextValidate validate this key rotation schedule based on the context it is used
...
func (m *KeyRotationSchedule) contextValidateSelfURI(ctx context.Context, formats strfmt.Registry) error {
