...
// ContextValidate validates this analytics resolution based on context it is used
func (m *AnalyticsResolution) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
