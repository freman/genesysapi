...
// ContextValidate validate this test matches operation based on the context it is used
func (m *TestMatchesOperation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TestMatchesOperation) contextValidateDetails(ctx context.Context, formats strfmt.Registry) error {
