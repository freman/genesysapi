...
// ContextValidate validates this routing status based on context it is used
func (m *RoutingStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
