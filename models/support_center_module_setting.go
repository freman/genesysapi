...
// ContextValidate validates this support center module setting based on context it is used
func (m *SupportCenterModuleSetting) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
