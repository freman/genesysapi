...
// ContextValidate validates this conversation reason based on context it is used
func (m *ConversationReason) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
