...
// QueueMemberEntityListing queue member entity listing
//
// swagger:model QueueMemberEntityListing
...
func (m *QueueMemberEntityListing) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *QueueMemberEntityListing) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *QueueMemberEntityListing) UnmarshalBinary(b []byte) error {
	var res QueueMemberEntityListing
