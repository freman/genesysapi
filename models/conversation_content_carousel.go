...
// ContextValidate validate this conversation content carousel based on the context it is used
func (m *ConversationContentCarousel) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ConversationContentCarousel) contextValidateCards(ctx context.Context, formats strfmt.Registry) error {
