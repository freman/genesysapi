...
// ContextValidate validate this management unit listing based on the context it is used
func (m *ManagementUnitListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ManagementUnitListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
