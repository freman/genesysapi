...
// Validate validates this management unit settings request
func (m *ManagementUnitSettingsRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ManagementUnitSettingsRequest) validateAdherence(formats strfmt.Registry) error {
...
func (m *ManagementUnitSettingsRequest) validateMetadata(formats strfmt.Registry) error {
...
func (m *ManagementUnitSettingsRequest) validateScheduling(formats strfmt.Registry) error {
...
func (m *ManagementUnitSettingsRequest) validateShiftTrading(formats strfmt.Registry) error {
...
func (m *ManagementUnitSettingsRequest) validateShortTermForecasting(formats strfmt.Registry) error {
...
func (m *ManagementUnitSettingsRequest) validateTimeOff(formats strfmt.Registry) error {
...
// ContextValidate validate this management unit settings request based on the context it is used
func (m *ManagementUnitSettingsRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ManagementUnitSettingsRequest) contextValidateAdherence(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ManagementUnitSettingsRequest) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ManagementUnitSettingsRequest) contextValidateScheduling(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ManagementUnitSettingsRequest) contextValidateShiftTrading(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ManagementUnitSettingsRequest) contextValidateShortTermForecasting(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ManagementUnitSettingsRequest) contextValidateTimeOff(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ManagementUnitSettingsRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ManagementUnitSettingsRequest) UnmarshalBinary(b []byte) error {
	var res ManagementUnitSettingsRequest
