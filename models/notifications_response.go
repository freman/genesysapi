...
func (m *NotificationsResponse) validateEntities(formats strfmt.Registry) error {
...
// ContextValidate validate this notifications response based on the context it is used
func (m *NotificationsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NotificationsResponse) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
