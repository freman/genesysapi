...
// ContextValidate validate this o auth authorization listing based on the context it is used
func (m *OAuthAuthorizationListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OAuthAuthorizationListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
