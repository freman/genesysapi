...
// ContextValidate validate this development activity aggregate query request clause based on the context it is used
func (m *DevelopmentActivityAggregateQueryRequestClause) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *DevelopmentActivityAggregateQueryRequestClause) contextValidatePredicates(ctx context.Context, formats strfmt.Registry) error {
