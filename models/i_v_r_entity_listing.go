...
// IVREntityListing i v r entity listing
//
// swagger:model IVREntityListing
...
// Validate validates this i v r entity listing
func (m *IVREntityListing) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IVREntityListing) validateEntities(formats strfmt.Registry) error {
...
func (m *IVREntityListing) validateFirstURI(formats strfmt.Registry) error {
...
func (m *IVREntityListing) validateLastURI(formats strfmt.Registry) error {
...
func (m *IVREntityListing) validateNextURI(formats strfmt.Registry) error {
...
func (m *IVREntityListing) validatePreviousURI(formats strfmt.Registry) error {
...
func (m *IVREntityListing) validateSelfURI(formats strfmt.Registry) error {
...
// ContextValidate validate this i v r entity listing based on the context it is used
func (m *IVREntityListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IVREntityListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IVREntityListing) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *IVREntityListing) UnmarshalBinary(b []byte) error {
	var res IVREntityListing
