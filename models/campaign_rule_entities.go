...
// CampaignRuleEntities campaign rule entities
//
// swagger:model CampaignRuleEntities
...
// Validate validates this campaign rule entities
func (m *CampaignRuleEntities) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CampaignRuleEntities) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CampaignRuleEntities) UnmarshalBinary(b []byte) error {
	var res CampaignRuleEntities
