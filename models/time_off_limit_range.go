...
// ContextValidate validates this time off limit range based on context it is used
func (m *TimeOffLimitRange) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
