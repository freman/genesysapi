...
// ContextValidate validate this salesforce based on the context it is used
func (m *Salesforce) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Salesforce) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Salesforce) contextValidateSelfURI(ctx context.Context, formats strfmt.Registry) error {
