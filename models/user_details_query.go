		...
		if m.PresenceAggregations[i] != nil {
			if err := m.PresenceAggregations[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("presenceAggregations" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.RoutingStatusAggregations[i] != nil {
			if err := m.RoutingStatusAggregations[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("routingStatusAggregations" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
// ContextValidate validate this user details query based on the context it is used
func (m *UserDetailsQuery) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
	...
	if err := m.contextValidatePresenceAggregations(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateRoutingStatusAggregations(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *UserDetailsQuery) contextValidatePaging(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UserDetailsQuery) contextValidatePresenceAggregations(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.PresenceAggregations); i++ {

		if m.PresenceAggregations[i] != nil {
			if err := m.PresenceAggregations[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("presenceAggregations" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("presenceAggregations" + "." + strconv.Itoa(i))
...
func (m *UserDetailsQuery) contextValidatePresenceFilters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UserDetailsQuery) contextValidateRoutingStatusAggregations(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.RoutingStatusAggregations); i++ {

		if m.RoutingStatusAggregations[i] != nil {
			if err := m.RoutingStatusAggregations[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("routingStatusAggregations" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("routingStatusAggregations" + "." + strconv.Itoa(i))
...
func (m *UserDetailsQuery) contextValidateRoutingStatusFilters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UserDetailsQuery) contextValidateUserFilters(ctx context.Context, formats strfmt.Registry) error {
