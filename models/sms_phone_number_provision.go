...
// ContextValidate validate this sms phone number provision based on the context it is used
func (m *SmsPhoneNumberProvision) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SmsPhoneNumberProvision) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SmsPhoneNumberProvision) contextValidateSelfURI(ctx context.Context, formats strfmt.Registry) error {
