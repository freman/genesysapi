...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ACDLANGUAGE","ACDSKILL","ACDWRAPUPCODE","BOTCONNECTORBOT","BOTCONNECTORBOTVERSION","BOTFLOW","BRIDGEACTION","COMMONMODULEFLOW","COMPOSERSCRIPT","CONTACTLIST","DATAACTION","DATATABLE","DIALOGENGINEBOT","DIALOGENGINEBOTVERSION","DIALOGFLOWAGENT","EMAILROUTE","EMERGENCYGROUP","FLOWACTION","FLOWDATATYPE","FLOWMILESTONE","FLOWOUTCOME","GROUP","INBOUNDCALLFLOW","INBOUNDCHATFLOW","INBOUNDEMAILFLOW","INBOUNDSHORTMESSAGEFLOW","INQUEUECALLFLOW","IVRCONFIGURATION","LANGUAGE","LEXBOT","LEXBOTALIAS","NLUDOMAIN","OUTBOUNDCALLFLOW","QUEUE","RECORDINGPOLICY","RESPONSE","SCHEDULE","SCHEDULEGROUP","SECUREACTION","SECURECALLFLOW","SURVEYINVITEFLOW","SYSTEMPROMPT","TTSENGINE","TTSVOICE","USER","USERPROMPT","WIDGET","WORKFLOW"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// DependencyObjectTypeBOTCONNECTORBOTVERSION captures enum value "BOTCONNECTORBOTVERSION"
	DependencyObjectTypeBOTCONNECTORBOTVERSION string = "BOTCONNECTORBOTVERSION"
