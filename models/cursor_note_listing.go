...
// ContextValidate validate this cursor note listing based on the context it is used
func (m *CursorNoteListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CursorNoteListing) contextValidateCursors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CursorNoteListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
