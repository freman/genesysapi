...
// ContextValidate validates this analytics proposed agent based on context it is used
func (m *AnalyticsProposedAgent) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
