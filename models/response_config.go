...
// ContextValidate validates this response config based on context it is used
func (m *ResponseConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
