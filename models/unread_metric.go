...
// ContextValidate validates this unread metric based on context it is used
func (m *UnreadMetric) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
