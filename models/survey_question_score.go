...
// ContextValidate validates this survey question score based on context it is used
func (m *SurveyQuestionScore) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
