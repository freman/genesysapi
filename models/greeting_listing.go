...
// GreetingListing greeting listing
//
// swagger:model GreetingListing
...
// Validate validates this greeting listing
func (m *GreetingListing) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GreetingListing) validateEntities(formats strfmt.Registry) error {
...
func (m *GreetingListing) validateFirstURI(formats strfmt.Registry) error {
...
func (m *GreetingListing) validateLastURI(formats strfmt.Registry) error {
...
func (m *GreetingListing) validateNextURI(formats strfmt.Registry) error {
...
func (m *GreetingListing) validatePreviousURI(formats strfmt.Registry) error {
...
func (m *GreetingListing) validateSelfURI(formats strfmt.Registry) error {
...
// ContextValidate validate this greeting listing based on the context it is used
func (m *GreetingListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GreetingListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GreetingListing) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GreetingListing) UnmarshalBinary(b []byte) error {
	var res GreetingListing
