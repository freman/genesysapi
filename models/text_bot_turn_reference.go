...
// ContextValidate validates this text bot turn reference based on context it is used
func (m *TextBotTurnReference) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
