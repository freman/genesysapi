...
// ContextValidate validates this transcript Url based on context it is used
func (m *TranscriptURL) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
