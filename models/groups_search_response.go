...
// ContextValidate validate this groups search response based on the context it is used
func (m *GroupsSearchResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GroupsSearchResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
