...
// SiteEntityListing site entity listing
//
// swagger:model SiteEntityListing
...
// Validate validates this site entity listing
func (m *SiteEntityListing) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SiteEntityListing) validateEntities(formats strfmt.Registry) error {
...
func (m *SiteEntityListing) validateFirstURI(formats strfmt.Registry) error {
...
func (m *SiteEntityListing) validateLastURI(formats strfmt.Registry) error {
...
func (m *SiteEntityListing) validateNextURI(formats strfmt.Registry) error {
...
func (m *SiteEntityListing) validatePreviousURI(formats strfmt.Registry) error {
...
func (m *SiteEntityListing) validateSelfURI(formats strfmt.Registry) error {
...
// ContextValidate validate this site entity listing based on the context it is used
func (m *SiteEntityListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SiteEntityListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SiteEntityListing) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SiteEntityListing) UnmarshalBinary(b []byte) error {
	var res SiteEntityListing
