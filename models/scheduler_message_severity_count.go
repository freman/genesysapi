...
// ContextValidate validates this scheduler message severity count based on context it is used
func (m *SchedulerMessageSeverityCount) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
