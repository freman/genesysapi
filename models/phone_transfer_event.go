...
// PhoneTransferEvent phone transfer event
//
// swagger:model PhoneTransferEvent
...
// Validate validates this phone transfer event
func (m *PhoneTransferEvent) Validate(formats strfmt.Registry) error {
	var res []error
	...
	if err := m.validateDestinationPhoneNumber(formats); err != nil {
		res = append(res, err)
	}
...
func (m *PhoneTransferEvent) validateCommandID(formats strfmt.Registry) error {
...
func (m *PhoneTransferEvent) validateConversationID(formats strfmt.Registry) error {
...
func (m *PhoneTransferEvent) validateDestinationPhoneNumber(formats strfmt.Registry) error {

	if err := validate.Required("destinationPhoneNumber", "body", m.DestinationPhoneNumber); err != nil {
		return err
	}
...
func (m *PhoneTransferEvent) validateEventDateTime(formats strfmt.Registry) error {
...
func (m *PhoneTransferEvent) validateEventID(formats strfmt.Registry) error {
...
func (m *PhoneTransferEvent) validateInitiatingCommunicationID(formats strfmt.Registry) error {
...
func (m *PhoneTransferEvent) validateObjectCommunicationID(formats strfmt.Registry) error {
...
func (m *PhoneTransferEvent) validateTargetCommunicationID(formats strfmt.Registry) error {
...
var phoneTransferEventTypeTransferTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		phoneTransferEventTypeTransferTypePropEnum = append(phoneTransferEventTypeTransferTypePropEnum, v)
	}
}

const (

	// PhoneTransferEventTransferTypeAttended captures enum value "Attended"
	PhoneTransferEventTransferTypeAttended string = "Attended"

	// PhoneTransferEventTransferTypeUnattended captures enum value "Unattended"
	PhoneTransferEventTransferTypeUnattended string = "Unattended"
)

// prop value enum
func (m *PhoneTransferEvent) validateTransferTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, phoneTransferEventTypeTransferTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *PhoneTransferEvent) validateTransferType(formats strfmt.Registry) error {
...
// ContextValidate validates this phone transfer event based on context it is used
func (m *PhoneTransferEvent) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *PhoneTransferEvent) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PhoneTransferEvent) UnmarshalBinary(b []byte) error {
	var res PhoneTransferEvent
