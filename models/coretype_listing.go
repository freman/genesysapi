...
// ContextValidate validate this coretype listing based on the context it is used
func (m *CoretypeListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CoretypeListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
