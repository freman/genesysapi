...
// ContextValidate validate this evaluation question based on the context it is used
func (m *EvaluationQuestion) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *EvaluationQuestion) contextValidateAnswerOptions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EvaluationQuestion) contextValidateVisibilityCondition(ctx context.Context, formats strfmt.Registry) error {
