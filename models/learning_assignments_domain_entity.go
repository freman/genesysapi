...
// LearningAssignmentsDomainEntity learning assignments domain entity
//
// swagger:model LearningAssignmentsDomainEntity
...
// Validate validates this learning assignments domain entity
func (m *LearningAssignmentsDomainEntity) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LearningAssignmentsDomainEntity) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *LearningAssignmentsDomainEntity) UnmarshalBinary(b []byte) error {
	var res LearningAssignmentsDomainEntity
