...
// FlowOutcomeListing flow outcome listing
//
// swagger:model FlowOutcomeListing
...
// Validate validates this flow outcome listing
func (m *FlowOutcomeListing) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *FlowOutcomeListing) validateEntities(formats strfmt.Registry) error {
...
func (m *FlowOutcomeListing) validateFirstURI(formats strfmt.Registry) error {
...
func (m *FlowOutcomeListing) validateLastURI(formats strfmt.Registry) error {
...
func (m *FlowOutcomeListing) validateNextURI(formats strfmt.Registry) error {
...
func (m *FlowOutcomeListing) validatePreviousURI(formats strfmt.Registry) error {
...
func (m *FlowOutcomeListing) validateSelfURI(formats strfmt.Registry) error {
...
// ContextValidate validate this flow outcome listing based on the context it is used
func (m *FlowOutcomeListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *FlowOutcomeListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FlowOutcomeListing) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *FlowOutcomeListing) UnmarshalBinary(b []byte) error {
	var res FlowOutcomeListing
