...
// ContextValidate validate this command status entity listing based on the context it is used
func (m *CommandStatusEntityListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CommandStatusEntityListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
