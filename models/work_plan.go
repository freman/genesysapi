...
var workPlanTypeShiftStartVarianceTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		workPlanTypeShiftStartVarianceTypePropEnum = append(workPlanTypeShiftStartVarianceTypePropEnum, v)
	}
}

const (

	// WorkPlanShiftStartVarianceTypeShiftStart captures enum value "ShiftStart"
	WorkPlanShiftStartVarianceTypeShiftStart string = "ShiftStart"

	// WorkPlanShiftStartVarianceTypeShiftStartAndPaidDuration captures enum value "ShiftStartAndPaidDuration"
	WorkPlanShiftStartVarianceTypeShiftStartAndPaidDuration string = "ShiftStartAndPaidDuration"
)

// prop value enum
func (m *WorkPlan) validateShiftStartVarianceTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, workPlanTypeShiftStartVarianceTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *WorkPlan) validateShiftStartVarianceType(formats strfmt.Registry) error {
...
// ContextValidate validate this work plan based on the context it is used
func (m *WorkPlan) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *WorkPlan) contextValidateAgents(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WorkPlan) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WorkPlan) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WorkPlan) contextValidateOptionalDays(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WorkPlan) contextValidateSelfURI(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WorkPlan) contextValidateShiftStartVariances(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WorkPlan) contextValidateShifts(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WorkPlan) contextValidateValid(ctx context.Context, formats strfmt.Registry) error {
