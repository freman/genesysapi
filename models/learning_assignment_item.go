...
// ContextValidate validates this learning assignment item based on context it is used
func (m *LearningAssignmentItem) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
