...
// NluFeedbackListing nlu feedback listing
//
// swagger:model NluFeedbackListing
...
// Validate validates this nlu feedback listing
func (m *NluFeedbackListing) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NluFeedbackListing) validateEntities(formats strfmt.Registry) error {
...
func (m *NluFeedbackListing) validateFirstURI(formats strfmt.Registry) error {
...
func (m *NluFeedbackListing) validateLastURI(formats strfmt.Registry) error {
...
func (m *NluFeedbackListing) validateNextURI(formats strfmt.Registry) error {
...
func (m *NluFeedbackListing) validatePreviousURI(formats strfmt.Registry) error {
...
func (m *NluFeedbackListing) validateSelfURI(formats strfmt.Registry) error {
...
// ContextValidate validate this nlu feedback listing based on the context it is used
func (m *NluFeedbackListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NluFeedbackListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NluFeedbackListing) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NluFeedbackListing) UnmarshalBinary(b []byte) error {
	var res NluFeedbackListing
