...
// ContextValidate validates this user schedule activity based on context it is used
func (m *UserScheduleActivity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
