...
func (m *CallbackConversation) validateRecentTransfers(formats strfmt.Registry) error {
...
func (m *CallbackConversation) contextValidateRecentTransfers(ctx context.Context, formats strfmt.Registry) error {
