...
// ActionMapListing action map listing
//
// swagger:model ActionMapListing
...
// Validate validates this action map listing
func (m *ActionMapListing) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ActionMapListing) validateEntities(formats strfmt.Registry) error {
...
func (m *ActionMapListing) validateFirstURI(formats strfmt.Registry) error {
...
func (m *ActionMapListing) validateLastURI(formats strfmt.Registry) error {
...
func (m *ActionMapListing) validateNextURI(formats strfmt.Registry) error {
...
func (m *ActionMapListing) validatePreviousURI(formats strfmt.Registry) error {
...
func (m *ActionMapListing) validateSelfURI(formats strfmt.Registry) error {
...
// ContextValidate validate this action map listing based on the context it is used
func (m *ActionMapListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ActionMapListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ActionMapListing) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ActionMapListing) UnmarshalBinary(b []byte) error {
	var res ActionMapListing
