...
// ContextValidate validates this notification template parameter based on context it is used
func (m *NotificationTemplateParameter) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
