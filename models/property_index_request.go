...
// ContextValidate validate this property index request based on the context it is used
func (m *PropertyIndexRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PropertyIndexRequest) contextValidateProperties(ctx context.Context, formats strfmt.Registry) error {
