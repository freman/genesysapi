...
// CreateWorkPlanActivity create work plan activity
//
// swagger:model CreateWorkPlanActivity
...
// Validate validates this create work plan activity
func (m *CreateWorkPlanActivity) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this create work plan activity based on context it is used
func (m *CreateWorkPlanActivity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *CreateWorkPlanActivity) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateWorkPlanActivity) UnmarshalBinary(b []byte) error {
	var res CreateWorkPlanActivity
