...
// ContextValidate validates this entity listing based on context it is used
func (m *EntityListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
