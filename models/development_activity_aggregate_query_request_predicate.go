...
// ContextValidate validates this development activity aggregate query request predicate based on context it is used
func (m *DevelopmentActivityAggregateQueryRequestPredicate) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
