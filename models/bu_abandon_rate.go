...
// ContextValidate validates this bu abandon rate based on context it is used
func (m *BuAbandonRate) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
