...
type Miner struct {
	...
	// Enum: [en-us en-gb en-au en-in en-za es-us es-es fr-fr fr-ca]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["en-us","en-gb","en-au","en-in","en-za","es-us","es-es","fr-fr","fr-ca"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
