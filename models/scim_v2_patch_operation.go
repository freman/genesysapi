...
// ContextValidate validates this scim v2 patch operation based on context it is used
func (m *ScimV2PatchOperation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
