...
// ContextValidate validates this message sticker attachment based on context it is used
func (m *MessageStickerAttachment) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
