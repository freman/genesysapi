...
// ContextValidate validates this tag query request based on context it is used
func (m *TagQueryRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
