...
// ContextValidate validates this idle event trigger based on context it is used
func (m *IdleEventTrigger) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
