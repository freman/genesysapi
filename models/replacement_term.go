...
// ContextValidate validates this replacement term based on context it is used
func (m *ReplacementTerm) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
