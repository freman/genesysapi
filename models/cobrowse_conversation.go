...
func (m *CobrowseConversation) validateRecentTransfers(formats strfmt.Registry) error {
...
// ContextValidate validate this cobrowse conversation based on the context it is used
func (m *CobrowseConversation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CobrowseConversation) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CobrowseConversation) contextValidateParticipants(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CobrowseConversation) contextValidateRecentTransfers(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CobrowseConversation) contextValidateSelfURI(ctx context.Context, formats strfmt.Registry) error {
