...
const (
	...
	// ReportingExportJobRequestViewTypeAGENTSCORECARDINSIGHTSSUMMARYVIEW captures enum value "AGENT_SCORECARD_INSIGHTS_SUMMARY_VIEW"
	ReportingExportJobRequestViewTypeAGENTSCORECARDINSIGHTSSUMMARYVIEW string = "AGENT_SCORECARD_INSIGHTS_SUMMARY_VIEW"

	// ReportingExportJobRequestViewTypeAGENTSCORECARDINSIGHTSDETAILVIEW captures enum value "AGENT_SCORECARD_INSIGHTS_DETAIL_VIEW"
	ReportingExportJobRequestViewTypeAGENTSCORECARDINSIGHTSDETAILVIEW string = "AGENT_SCORECARD_INSIGHTS_DETAIL_VIEW"

	// ReportingExportJobRequestViewTypeQUEUEWRAPUPDETAILVIEW captures enum value "QUEUE_WRAPUP_DETAIL_VIEW"
	ReportingExportJobRequestViewTypeQUEUEWRAPUPDETAILVIEW string = "QUEUE_WRAPUP_DETAIL_VIEW"

	// ReportingExportJobRequestViewTypeINTERACTIONDETAILVIEW captures enum value "INTERACTION_DETAIL_VIEW"
	ReportingExportJobRequestViewTypeINTERACTIONDETAILVIEW string = "INTERACTION_DETAIL_VIEW"

	// ReportingExportJobRequestViewTypeCAMPAIGNINTERACTIONDETAILVIEW captures enum value "CAMPAIGN_INTERACTION_DETAIL_VIEW"
	ReportingExportJobRequestViewTypeCAMPAIGNINTERACTIONDETAILVIEW string = "CAMPAIGN_INTERACTION_DETAIL_VIEW"

	// ReportingExportJobRequestViewTypeCAMPAIGNATTEMPTDETAILVIEW captures enum value "CAMPAIGN_ATTEMPT_DETAIL_VIEW"
	ReportingExportJobRequestViewTypeCAMPAIGNATTEMPTDETAILVIEW string = "CAMPAIGN_ATTEMPT_DETAIL_VIEW"

	// ReportingExportJobRequestViewTypeWORKITEMPERFORMANCESUMMARYVIEW captures enum value "WORKITEM_PERFORMANCE_SUMMARY_VIEW"
	ReportingExportJobRequestViewTypeWORKITEMPERFORMANCESUMMARYVIEW string = "WORKITEM_PERFORMANCE_SUMMARY_VIEW"
)
...
// ContextValidate validate this reporting export job request based on the context it is used
func (m *ReportingExportJobRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ReportingExportJobRequest) contextValidateFilter(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReportingExportJobRequest) contextValidateSelectedColumns(ctx context.Context, formats strfmt.Registry) error {
