...
// ContextValidate validate this routing established event based on the context it is used
func (m *RoutingEstablishedEvent) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RoutingEstablishedEvent) contextValidateInitialConfiguration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RoutingEstablishedEvent) contextValidateSourceConfiguration(ctx context.Context, formats strfmt.Registry) error {
