...
// EdgeEntityListing edge entity listing
//
// swagger:model EdgeEntityListing
...
// Validate validates this edge entity listing
func (m *EdgeEntityListing) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EdgeEntityListing) validateEntities(formats strfmt.Registry) error {
...
func (m *EdgeEntityListing) validateFirstURI(formats strfmt.Registry) error {
...
func (m *EdgeEntityListing) validateLastURI(formats strfmt.Registry) error {
...
func (m *EdgeEntityListing) validateNextURI(formats strfmt.Registry) error {
...
func (m *EdgeEntityListing) validatePreviousURI(formats strfmt.Registry) error {
...
func (m *EdgeEntityListing) validateSelfURI(formats strfmt.Registry) error {
...
// ContextValidate validate this edge entity listing based on the context it is used
func (m *EdgeEntityListing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *EdgeEntityListing) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EdgeEntityListing) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *EdgeEntityListing) UnmarshalBinary(b []byte) error {
	var res EdgeEntityListing
