...
// CrossPlatformPolicy cross platform policy
//
// swagger:model CrossPlatformPolicy
...
// Validate validates this cross platform policy
func (m *CrossPlatformPolicy) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CrossPlatformPolicy) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CrossPlatformPolicy) UnmarshalBinary(b []byte) error {
	var res CrossPlatformPolicy
