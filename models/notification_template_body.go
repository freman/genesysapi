...
// ContextValidate validate this notification template body based on the context it is used
func (m *NotificationTemplateBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NotificationTemplateBody) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
