...
// ConsultTransferEvent consult transfer event
//
// swagger:model ConsultTransferEvent
...
// Validate validates this consult transfer event
func (m *ConsultTransferEvent) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ConsultTransferEvent) validateConversationID(formats strfmt.Registry) error {
...
func (m *ConsultTransferEvent) validateDestinationCommunicationID(formats strfmt.Registry) error {
...
func (m *ConsultTransferEvent) validateEventDateTime(formats strfmt.Registry) error {
...
func (m *ConsultTransferEvent) validateEventID(formats strfmt.Registry) error {
...
func (m *ConsultTransferEvent) validateInitiatingCommunicationID(formats strfmt.Registry) error {
...
func (m *ConsultTransferEvent) validateObjectCommunicationID(formats strfmt.Registry) error {
...
// ContextValidate validates this consult transfer event based on context it is used
func (m *ConsultTransferEvent) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ConsultTransferEvent) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ConsultTransferEvent) UnmarshalBinary(b []byte) error {
	var res ConsultTransferEvent
