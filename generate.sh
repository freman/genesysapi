...
swagger generate client --allow-template-override -f https://github.com/MyPureCloud/platform-client-sdk-go/raw/master/swagger.json -A genesys --skip-validation -T swagger-template
